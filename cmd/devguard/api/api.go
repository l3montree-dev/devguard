...
func Start(db core.DB) {
	...
	assetController := asset.NewHttpController(assetRepository, componentRepository, dependencyVulnRepository, assetService, supplyChainRepository)
	...
	tenantRouter.GET("/dependencyVulns/", dependencyVulnController.ListByOrgPaged)
	...
	tenantRouter.GET("/stats/dependencyVuln-aggregation-state-and-change/", statisticsController.GetOrgDependencyVulnAggregationStateAndChange)
	...
	projectRouter.GET("/dependencyVulns/", dependencyVulnController.ListByProjectPaged)
	...
	projectRouter.GET("/stats/dependencyVuln-aggregation-state-and-change/", statisticsController.GetProjectDependencyVulnAggregationStateAndChange)
	...
	assetRouter.GET("/stats/dependencyVuln-count-by-scanner/", statisticsController.GetDependencyVulnCountByScannerId)
	assetRouter.GET("/stats/dependency-count-by-scan-type/", statisticsController.GetDependencyCountPerScanner)
	assetRouter.GET("/stats/dependencyVuln-aggregation-state-and-change/", statisticsController.GetDependencyVulnAggregationStateAndChange)
