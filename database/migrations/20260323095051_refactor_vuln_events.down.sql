...
--   1. Table anpassen
--     - license risks
--   2. Beziehungen anpassen
--     - vuln_events
--     - artifact license risk

-- -- Vuln Events Anpassen


-- New pkey Spalte -> Werte duplizieren 

-- -> alle foreign key spalten duplizieren -> Werte transformieren und duplizieren in neue Spalte

-- -> primary key droppen -> foreing key column droppen -> primary key neu bauen ->  -> primary key der hauptspalte droppen

-- -> neuen pkey setzen -> foreign keys updaten
