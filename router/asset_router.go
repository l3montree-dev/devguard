...
func NewAssetRouter(
	...
	*/
	...
	assetRouter.GET("/compliance/", complianceController.AssetScopedCompliance)
	assetRouter.GET("/compliance/:policy/", complianceController.AssetDetails)
	assetRouter.GET("/number-of-exploits/", statisticsController.GetCVESWithKnownExploits)
	assetRouter.GET("/components/licenses/", componentController.AssetLicenseDistribution)
	...
	assetUpdateAccessControlRequired.GET("/pats/", patController.ListByAsset)
