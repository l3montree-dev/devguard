...
func NewAdvisoryRouter(
	...
	advisoryRouter.POST("/:id/events/", advisoryController.CreateEvent, middlewares.NeededScope([]string{"manage"}), middlewares.AssetAccessControl(shared.ObjectAsset, shared.ActionUpdate))
