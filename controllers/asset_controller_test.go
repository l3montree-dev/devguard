...
func TestHTTPControllerInviteMembers(t *testing.T) {
	...
	t.Run("successfully invites members", func(t *testing.T) {
		...
		// Mock granting roles
		mockRBAC.On("GrantRoleInAsset", mock.Anything, shared.NewSession("user-123", shared.SessionActorUser, nil, false), shared.RoleMember, assetID.String()).Return(nil)
		mockRBAC.On("GrantRoleInAsset", mock.Anything, shared.NewSession("user-456", shared.SessionActorUser, nil, false), shared.RoleMember, assetID.String()).Return(nil)

		shared.SetAsset(ctx, asset)
		shared.SetRBAC(ctx, mockRBAC)
		session := mocks.NewAuthSession(t)
		session.On("GetActorID").Return("user-123")
...
func TestHTTPControllerRemoveMember(t *testing.T) {
	...
	t.Run("successfully removes member", func(t *testing.T) {
		...
		mockRBAC := mocks.NewAccessControl(t)
		mockRBAC.On("RevokeRoleInAsset", mock.Anything, shared.NewSession("user-123", shared.SessionActorUser, nil, false), shared.RoleAdmin, assetID.String()).Return(nil)
		mockRBAC.On("RevokeRoleInAsset", mock.Anything, shared.NewSession("user-123", shared.SessionActorUser, nil, false), shared.RoleMember, assetID.String()).Return(nil)
	...
	t.Run("removes member even when revoke fails (nolint)", func(t *testing.T) {
		...
		mockRBAC.On("RevokeRoleInAsset", mock.Anything, shared.NewSession("user-123", shared.SessionActorUser, nil, false), shared.RoleAdmin, assetID.String()).Return(errors.New("not an admin"))
		mockRBAC.On("RevokeRoleInAsset", mock.Anything, shared.NewSession("user-123", shared.SessionActorUser, nil, false), shared.RoleMember, assetID.String()).Return(errors.New("not a member"))
