...
func NewGitlabIntegration(db shared.DB, oauth2GitlabIntegration map[string]*GitlabOauth2Config, casbinRBACProvider shared.RBACProvider, clientFactory shared.GitlabClientFactory) *GitlabIntegration {
