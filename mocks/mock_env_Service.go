...
// EnvService is an autogenerated mock type for the Service type
type EnvService struct {
	mock.Mock
}

type EnvService_Expecter struct {
	mock *mock.Mock
}

func (_m *EnvService) EXPECT() *EnvService_Expecter {
...
// EnvService_CreateDefaultEnvForApp_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateDefaultEnvForApp'
type EnvService_CreateDefaultEnvForApp_Call struct {
	*mock.Call
}
...
func (_c *EnvService_CreateDefaultEnvForApp_Call) Return(_a0 []env.Model, _a1 error) *EnvService_CreateDefaultEnvForApp_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EnvService_CreateDefaultEnvForApp_Call) RunAndReturn(run func(*gorm.DB, uuid.UUID) ([]env.Model, error)) *EnvService_CreateDefaultEnvForApp_Call {
	_c.Call.Return(run)
	return _c
}
