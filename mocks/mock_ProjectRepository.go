...
// NextSlug provides a mock function for the type ProjectRepository
func (_mock *ProjectRepository) NextSlug(orgID uuid.UUID, projectSlug string) (string, error) {
	ret := _mock.Called(orgID, projectSlug)
...
// ProjectRepository_NextSlug_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NextSlug'
type ProjectRepository_NextSlug_Call struct {
	*mock.Call
}
...
//   - orgID uuid.UUID
//   - projectSlug string
func (_e *ProjectRepository_Expecter) NextSlug(orgID interface{}, projectSlug interface{}) *ProjectRepository_NextSlug_Call {
	return &ProjectRepository_NextSlug_Call{Call: _e.mock.On("NextSlug", orgID, projectSlug)}
}

func (_c *ProjectRepository_NextSlug_Call) Run(run func(orgID uuid.UUID, projectSlug string)) *ProjectRepository_NextSlug_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 uuid.UUID
		if args[0] != nil {
			arg0 = args[0].(uuid.UUID)
...
func (_c *ProjectRepository_NextSlug_Call) Return(s string, err error) *ProjectRepository_NextSlug_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *ProjectRepository_NextSlug_Call) RunAndReturn(run func(orgID uuid.UUID, projectSlug string) (string, error)) *ProjectRepository_NextSlug_Call {
	_c.Call.Return(run)
	return _c
}
