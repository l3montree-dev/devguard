...
func (_c *StatisticsAssetRepository_Save_Call) Run(run func(tx core.DB, asset *models.Asset)) *StatisticsAssetRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StatisticsAssetRepository_Save_Call) RunAndReturn(run func(core.DB, *models.Asset) error) *StatisticsAssetRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
