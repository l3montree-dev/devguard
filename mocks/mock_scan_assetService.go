...
func (_m *ScanAssetService) HandleScanResult(asset models.Asset, vulns []models.VulnInPackage, scanType string, version string, scannerID string, userID string) (int, int, []models.Flaw, error) {
	ret := _m.Called(asset, vulns, scanType, version, scannerID, userID)
	...
	var r2 []models.Flaw
	var r3 error
	if rf, ok := ret.Get(0).(func(models.Asset, []models.VulnInPackage, string, string, string, string) (int, int, []models.Flaw, error)); ok {
		return rf(asset, vulns, scanType, version, scannerID, userID)
	}
	if rf, ok := ret.Get(0).(func(models.Asset, []models.VulnInPackage, string, string, string, string) int); ok {
		r0 = rf(asset, vulns, scanType, version, scannerID, userID)
	} else {
		r0 = ret.Get(0).(int)
	}

	if rf, ok := ret.Get(1).(func(models.Asset, []models.VulnInPackage, string, string, string, string) int); ok {
		r1 = rf(asset, vulns, scanType, version, scannerID, userID)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(models.Asset, []models.VulnInPackage, string, string, string, string) []models.Flaw); ok {
		r2 = rf(asset, vulns, scanType, version, scannerID, userID)
	} else {
		if ret.Get(2) != nil {
	...
	if rf, ok := ret.Get(3).(func(models.Asset, []models.VulnInPackage, string, string, string, string) error); ok {
		r3 = rf(asset, vulns, scanType, version, scannerID, userID)
	} else {
		r3 = ret.Error(3)
	}
...
func (_e *ScanAssetService_Expecter) HandleScanResult(asset interface{}, vulns interface{}, scanType interface{}, version interface{}, scannerID interface{}, userID interface{}) *ScanAssetService_HandleScanResult_Call {
	return &ScanAssetService_HandleScanResult_Call{Call: _e.mock.On("HandleScanResult", asset, vulns, scanType, version, scannerID, userID)}
}
...
func (_c *ScanAssetService_HandleScanResult_Call) Run(run func(asset models.Asset, vulns []models.VulnInPackage, scanType string, version string, scannerID string, userID string)) *ScanAssetService_HandleScanResult_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(models.Asset), args[1].([]models.VulnInPackage), args[2].(string), args[3].(string), args[4].(string), args[5].(string))
	})
	return _c
}
