...
func (_c *OrgProjectService_ListAllowedProjects_Call) Run(run func(c core.Context)) *OrgProjectService_ListAllowedProjects_Call {
...
func (_c *OrgProjectService_ListAllowedProjects_Call) RunAndReturn(run func(core.Context) ([]models.Project, error)) *OrgProjectService_ListAllowedProjects_Call {
	_c.Call.Return(run)
	return _c
}
