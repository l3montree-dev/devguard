...
// AddSSHKey provides a mock function with given fields: ctx, projectId, opt
func (_m *IntegrationsGitlabClientFacade) AddSSHKey(ctx context.Context, projectId int, opt *gitlab.AddSSHKeyOptions) (*gitlab.SSHKey, *gitlab.Response, error) {
	ret := _m.Called(ctx, projectId, opt)
	...
	var r1 *gitlab.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, int, *gitlab.AddSSHKeyOptions) (*gitlab.SSHKey, *gitlab.Response, error)); ok {
		return rf(ctx, projectId, opt)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, *gitlab.AddSSHKeyOptions) *gitlab.SSHKey); ok {
		r0 = rf(ctx, projectId, opt)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, int, *gitlab.AddSSHKeyOptions) *gitlab.Response); ok {
		r1 = rf(ctx, projectId, opt)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*gitlab.Response)
	...
	if rf, ok := ret.Get(2).(func(context.Context, int, *gitlab.AddSSHKeyOptions) error); ok {
		r2 = rf(ctx, projectId, opt)
	} else {
		r2 = ret.Error(2)
	}
...
// IntegrationsGitlabClientFacade_AddSSHKey_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddSSHKey'
type IntegrationsGitlabClientFacade_AddSSHKey_Call struct {
	*mock.Call
}
...
func (_e *IntegrationsGitlabClientFacade_Expecter) AddSSHKey(ctx interface{}, projectId interface{}, opt interface{}) *IntegrationsGitlabClientFacade_AddSSHKey_Call {
	return &IntegrationsGitlabClientFacade_AddSSHKey_Call{Call: _e.mock.On("AddSSHKey", ctx, projectId, opt)}
}

func (_c *IntegrationsGitlabClientFacade_AddSSHKey_Call) Run(run func(ctx context.Context, projectId int, opt *gitlab.AddSSHKeyOptions)) *IntegrationsGitlabClientFacade_AddSSHKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int), args[2].(*gitlab.AddSSHKeyOptions))
	})
	return _c
}

func (_c *IntegrationsGitlabClientFacade_AddSSHKey_Call) Return(_a0 *gitlab.SSHKey, _a1 *gitlab.Response, _a2 error) *IntegrationsGitlabClientFacade_AddSSHKey_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *IntegrationsGitlabClientFacade_AddSSHKey_Call) RunAndReturn(run func(context.Context, int, *gitlab.AddSSHKeyOptions) (*gitlab.SSHKey, *gitlab.Response, error)) *IntegrationsGitlabClientFacade_AddSSHKey_Call {
	_c.Call.Return(run)
	return _c
}
...
// DeleteSSHKey provides a mock function with given fields: ctx, keyId
func (_m *IntegrationsGitlabClientFacade) DeleteSSHKey(ctx context.Context, keyId int) (*gitlab.Response, error) {
	...
	var r0 *gitlab.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) (*gitlab.Response, error)); ok {
		return rf(ctx, keyId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int) *gitlab.Response); ok {
		r0 = rf(ctx, keyId)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gitlab.Response)
...
// IntegrationsGitlabClientFacade_DeleteSSHKey_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteSSHKey'
type IntegrationsGitlabClientFacade_DeleteSSHKey_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - keyId int
func (_e *IntegrationsGitlabClientFacade_Expecter) DeleteSSHKey(ctx interface{}, keyId interface{}) *IntegrationsGitlabClientFacade_DeleteSSHKey_Call {
	return &IntegrationsGitlabClientFacade_DeleteSSHKey_Call{Call: _e.mock.On("DeleteSSHKey", ctx, keyId)}
}

func (_c *IntegrationsGitlabClientFacade_DeleteSSHKey_Call) Run(run func(ctx context.Context, keyId int)) *IntegrationsGitlabClientFacade_DeleteSSHKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IntegrationsGitlabClientFacade_DeleteSSHKey_Call) Return(_a0 *gitlab.Response, _a1 error) *IntegrationsGitlabClientFacade_DeleteSSHKey_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *IntegrationsGitlabClientFacade_DeleteSSHKey_Call) RunAndReturn(run func(context.Context, int) (*gitlab.Response, error)) *IntegrationsGitlabClientFacade_DeleteSSHKey_Call {
	_c.Call.Return(run)
	return _c
}
