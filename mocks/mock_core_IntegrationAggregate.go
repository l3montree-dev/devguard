...
// CoreIntegrationAggregate_CreateIssue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateIssue'
type CoreIntegrationAggregate_CreateIssue_Call struct {
	*mock.Call
}
...
func (_c *CoreIntegrationAggregate_CreateIssue_Call) Return(_a0 error) *CoreIntegrationAggregate_CreateIssue_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *CoreIntegrationAggregate) UpdateIssue(ctx context.Context, asset models.Asset, repoId string, dependencyVuln models.DependencyVuln) error {
...
// CoreIntegrationAggregate_UpdateIssue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateIssue'
type CoreIntegrationAggregate_UpdateIssue_Call struct {
	*mock.Call
}
...
//   - repoId string
//   - dependencyVuln models.DependencyVuln
func (_e *CoreIntegrationAggregate_Expecter) UpdateIssue(ctx interface{}, asset interface{}, repoId interface{}, dependencyVuln interface{}) *CoreIntegrationAggregate_UpdateIssue_Call {
	return &CoreIntegrationAggregate_UpdateIssue_Call{Call: _e.mock.On("UpdateIssue", ctx, asset, repoId, dependencyVuln)}
}

func (_c *CoreIntegrationAggregate_UpdateIssue_Call) Run(run func(ctx context.Context, asset models.Asset, repoId string, dependencyVuln models.DependencyVuln)) *CoreIntegrationAggregate_UpdateIssue_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CoreIntegrationAggregate_UpdateIssue_Call) Return(_a0 error) *CoreIntegrationAggregate_UpdateIssue_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CoreIntegrationAggregate_UpdateIssue_Call) RunAndReturn(run func(context.Context, models.Asset, string, models.DependencyVuln) error) *CoreIntegrationAggregate_UpdateIssue_Call {
	_c.Call.Return(run)
	return _c
}
