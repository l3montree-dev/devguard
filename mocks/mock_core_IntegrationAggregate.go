...
func (_c *CoreIntegrationAggregate_HandleEvent_Call) Run(run func(event any)) *CoreIntegrationAggregate_HandleEvent_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(any))
	})
	return _c
...
func (_c *CoreIntegrationAggregate_HandleEvent_Call) RunAndReturn(run func(any) error) *CoreIntegrationAggregate_HandleEvent_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CoreIntegrationAggregate_HandleWebhook_Call) Run(run func(ctx core.Context)) *CoreIntegrationAggregate_HandleWebhook_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CoreIntegrationAggregate_HandleWebhook_Call) RunAndReturn(run func(core.Context) error) *CoreIntegrationAggregate_HandleWebhook_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CoreIntegrationAggregate_IntegrationEnabled_Call) Run(run func(ctx core.Context)) *CoreIntegrationAggregate_IntegrationEnabled_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.Context))
	})
	return _c
...
func (_c *CoreIntegrationAggregate_IntegrationEnabled_Call) RunAndReturn(run func(core.Context) bool) *CoreIntegrationAggregate_IntegrationEnabled_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CoreIntegrationAggregate_ListRepositories_Call) Run(run func(ctx core.Context)) *CoreIntegrationAggregate_ListRepositories_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.Context))
	})
	return _c
...
func (_c *CoreIntegrationAggregate_ListRepositories_Call) RunAndReturn(run func(core.Context) ([]core.Repository, error)) *CoreIntegrationAggregate_ListRepositories_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CoreIntegrationAggregate_WantsToHandleWebhook_Call) Run(run func(ctx core.Context)) *CoreIntegrationAggregate_WantsToHandleWebhook_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.Context))
	})
	return _c
...
func (_c *CoreIntegrationAggregate_WantsToHandleWebhook_Call) RunAndReturn(run func(core.Context) bool) *CoreIntegrationAggregate_WantsToHandleWebhook_Call {
	_c.Call.Return(run)
	return _c
}
