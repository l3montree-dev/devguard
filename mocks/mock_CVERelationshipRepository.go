...
// InBatches provides a mock function for the type CVERelationshipRepository
func (_mock *CVERelationshipRepository) InBatches(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.CVERelationship, error] {
	...
	var r0 iter.Seq2[[]models.CVERelationship, error]
	if returnFunc, ok := ret.Get(0).(func(context.Context, shared.DB, int) iter.Seq2[[]models.CVERelationship, error]); ok {
		r0 = returnFunc(ctx, tx, batchSize)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(iter.Seq2[[]models.CVERelationship, error])
		}
	}
	return r0
}

// CVERelationshipRepository_InBatches_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InBatches'
type CVERelationshipRepository_InBatches_Call struct {
	*mock.Call
}
...
func (_c *CVERelationshipRepository_InBatches_Call) Run(run func(ctx context.Context, tx shared.DB, batchSize int)) *CVERelationshipRepository_InBatches_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *CVERelationshipRepository_InBatches_Call) Return(seq2 iter.Seq2[[]models.CVERelationship, error]) *CVERelationshipRepository_InBatches_Call {
	_c.Call.Return(seq2)
	return _c
}

func (_c *CVERelationshipRepository_InBatches_Call) RunAndReturn(run func(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.CVERelationship, error]) *CVERelationshipRepository_InBatches_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - tx shared.DB
//   - ts []models.CVERelationship
func (_e *CVERelationshipRepository_Expecter) SaveBatchBestEffort(ctx any, tx any, ts any) *CVERelationshipRepository_SaveBatchBestEffort_Call {
