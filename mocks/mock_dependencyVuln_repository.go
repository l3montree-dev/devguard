...
func (_m *DependencyVulnRepository) GetDependencyVulnsByAssetVersion(tx *gorm.DB, assetVersionName string, assetVersionID uuid.UUID) ([]models.DependencyVuln, error) {
...
func (_e *DependencyVulnRepository_Expecter) GetDependencyVulnsByAssetVersion(tx interface{}, assetVersionName interface{}, assetVersionID interface{}) *DependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	return &DependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call{Call: _e.mock.On("GetDependencyVulnsByAssetVersion", tx, assetVersionName, assetVersionID)}
}

func (_c *DependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetVersionID uuid.UUID)) *DependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// ReadDependencyVulnWithAssetEvents provides a mock function with given fields: id
func (_m *DependencyVulnRepository) ReadDependencyVulnWithAssetEvents(id string) (models.DependencyVuln, []models.VulnEvent, error) {
	ret := _m.Called(id)

	if len(ret) == 0 {
		panic("no return value specified for ReadDependencyVulnWithAssetEvents")
	}
...
// DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReadDependencyVulnWithAssetEvents'
type DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call struct {
	*mock.Call
}

// ReadDependencyVulnWithAssetEvents is a helper method to define mock.On call
//   - id string
func (_e *DependencyVulnRepository_Expecter) ReadDependencyVulnWithAssetEvents(id interface{}) *DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call {
	return &DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call{Call: _e.mock.On("ReadDependencyVulnWithAssetEvents", id)}
}

func (_c *DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call) Run(run func(id string)) *DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call) Return(_a0 models.DependencyVuln, _a1 []models.VulnEvent, _a2 error) *DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call) RunAndReturn(run func(string) (models.DependencyVuln, []models.VulnEvent, error)) *DependencyVulnRepository_ReadDependencyVulnWithAssetEvents_Call {
	_c.Call.Return(run)
	return _c
}
