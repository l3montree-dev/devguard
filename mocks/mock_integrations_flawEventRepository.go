...
// IntegrationsDependencyVulnEventRepository is an autogenerated mock type for the dependencyVulnEventRepository type
...
func (_m *IntegrationsDependencyVulnEventRepository) Save(db *gorm.DB, event *models.DependencyVulnEvent) error {
...
func (_c *IntegrationsDependencyVulnEventRepository_Save_Call) Run(run func(db *gorm.DB, event *models.DependencyVulnEvent)) *IntegrationsDependencyVulnEventRepository_Save_Call {
...
func (_c *IntegrationsDependencyVulnEventRepository_Save_Call) RunAndReturn(run func(*gorm.DB, *models.DependencyVulnEvent) error) *IntegrationsDependencyVulnEventRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
