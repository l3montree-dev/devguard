...
func (_m *IntegrationsGitlabIntegrationRepository) Delete(tx core.DB, id uuid.UUID) error {
	ret := _m.Called(tx, id)
...
func (_c *IntegrationsGitlabIntegrationRepository_Delete_Call) Run(run func(tx core.DB, id uuid.UUID)) *IntegrationsGitlabIntegrationRepository_Delete_Call {
...
func (_c *IntegrationsGitlabIntegrationRepository_Delete_Call) RunAndReturn(run func(core.DB, uuid.UUID) error) *IntegrationsGitlabIntegrationRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *IntegrationsGitlabIntegrationRepository) Save(tx core.DB, model *models.GitLabIntegration) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, *models.GitLabIntegration) error); ok {
		r0 = rf(tx, model)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *IntegrationsGitlabIntegrationRepository_Save_Call) Run(run func(tx core.DB, model *models.GitLabIntegration)) *IntegrationsGitlabIntegrationRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IntegrationsGitlabIntegrationRepository_Save_Call) RunAndReturn(run func(core.DB, *models.GitLabIntegration) error) *IntegrationsGitlabIntegrationRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
