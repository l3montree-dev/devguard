...
// GetVEXRulesForAsset provides a mock function for the type VulnEventRepository
func (_mock *VulnEventRepository) GetVEXRulesForAsset(tx shared.DB, assetID uuid.UUID) ([]shared.VEXRule, error) {
	ret := _mock.Called(tx, assetID)

	if len(ret) == 0 {
		panic("no return value specified for GetVEXRulesForAsset")
	}

	var r0 []shared.VEXRule
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(shared.DB, uuid.UUID) ([]shared.VEXRule, error)); ok {
		return returnFunc(tx, assetID)
	}
	if returnFunc, ok := ret.Get(0).(func(shared.DB, uuid.UUID) []shared.VEXRule); ok {
		r0 = returnFunc(tx, assetID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]shared.VEXRule)
		}
	}
...
// VulnEventRepository_GetVEXRulesForAsset_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetVEXRulesForAsset'
type VulnEventRepository_GetVEXRulesForAsset_Call struct {
	*mock.Call
}

// GetVEXRulesForAsset is a helper method to define mock.On call
//   - tx shared.DB
//   - assetID uuid.UUID
func (_e *VulnEventRepository_Expecter) GetVEXRulesForAsset(tx interface{}, assetID interface{}) *VulnEventRepository_GetVEXRulesForAsset_Call {
	return &VulnEventRepository_GetVEXRulesForAsset_Call{Call: _e.mock.On("GetVEXRulesForAsset", tx, assetID)}
}

func (_c *VulnEventRepository_GetVEXRulesForAsset_Call) Run(run func(tx shared.DB, assetID uuid.UUID)) *VulnEventRepository_GetVEXRulesForAsset_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 shared.DB
		if args[0] != nil {
			arg0 = args[0].(shared.DB)
...
func (_c *VulnEventRepository_GetVEXRulesForAsset_Call) Return(vEXRules []shared.VEXRule, err error) *VulnEventRepository_GetVEXRulesForAsset_Call {
	_c.Call.Return(vEXRules, err)
	return _c
}

func (_c *VulnEventRepository_GetVEXRulesForAsset_Call) RunAndReturn(run func(tx shared.DB, assetID uuid.UUID) ([]shared.VEXRule, error)) *VulnEventRepository_GetVEXRulesForAsset_Call {
	_c.Call.Return(run)
	return _c
}
