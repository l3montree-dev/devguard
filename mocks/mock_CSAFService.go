...
func (_mock *CSAFService) GetVexFromCsafProvider(purl packageurl.PackageURL, domain string) (*normalize.CdxBom, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(packageurl.PackageURL, string) (*normalize.CdxBom, error)); ok {
		return returnFunc(purl, domain)
	}
	if returnFunc, ok := ret.Get(0).(func(packageurl.PackageURL, string) *normalize.CdxBom); ok {
...
func (_c *CSAFService_GetVexFromCsafProvider_Call) RunAndReturn(run func(purl packageurl.PackageURL, domain string) (*normalize.CdxBom, error)) *CSAFService_GetVexFromCsafProvider_Call {
	_c.Call.Return(run)
	return _c
}
