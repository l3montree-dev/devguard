...
func (_m *StatisticsStatisticsRepository) GetAssetRiskDistribution(assetID uuid.UUID) ([]models.AssetRiskDistribution, error) {
...
//   - assetID uuid.UUID
func (_e *StatisticsStatisticsRepository_Expecter) GetAssetRiskDistribution(assetID interface{}) *StatisticsStatisticsRepository_GetAssetRiskDistribution_Call {
	return &StatisticsStatisticsRepository_GetAssetRiskDistribution_Call{Call: _e.mock.On("GetAssetRiskDistribution", assetID)}
}

func (_c *StatisticsStatisticsRepository_GetAssetRiskDistribution_Call) Run(run func(assetID uuid.UUID)) *StatisticsStatisticsRepository_GetAssetRiskDistribution_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StatisticsStatisticsRepository_GetAssetRiskDistribution_Call) RunAndReturn(run func(uuid.UUID) ([]models.AssetRiskDistribution, error)) *StatisticsStatisticsRepository_GetAssetRiskDistribution_Call {
	_c.Call.Return(run)
	return _c
}
