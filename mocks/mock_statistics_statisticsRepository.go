...
func (_m *StatisticsStatisticsRepository) TimeTravelDependencyVulnState(assetID uuid.UUID, _a1 time.Time) ([]models.DependencyVulnerability, error) {
...
func (_c *StatisticsStatisticsRepository_TimeTravelDependencyVulnState_Call) Return(_a0 []models.DependencyVulnerability, _a1 error) *StatisticsStatisticsRepository_TimeTravelDependencyVulnState_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StatisticsStatisticsRepository_TimeTravelDependencyVulnState_Call) RunAndReturn(run func(uuid.UUID, time.Time) ([]models.DependencyVulnerability, error)) *StatisticsStatisticsRepository_TimeTravelDependencyVulnState_Call {
	_c.Call.Return(run)
	return _c
}
