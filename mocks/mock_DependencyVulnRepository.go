...
//   - cutoff *time.Time
func (_e *DependencyVulnRepository_Expecter) AttachGroupEvents(ctx interface{}, tx interface{}, vulns interface{}, cutoff interface{}) *DependencyVulnRepository_AttachGroupEvents_Call {
