...
func (_mock *DependencyVulnRepository) GetHintsInOrganizationForVuln(tx core.DB, orgID uuid.UUID, pURL string, cveID string) (models.DependencyVulnHints, error) {
	...
	var r0 models.DependencyVulnHints
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(core.DB, uuid.UUID, string, string) (models.DependencyVulnHints, error)); ok {
		return returnFunc(tx, orgID, pURL, cveID)
	}
	if returnFunc, ok := ret.Get(0).(func(core.DB, uuid.UUID, string, string) models.DependencyVulnHints); ok {
		r0 = returnFunc(tx, orgID, pURL, cveID)
	} else {
		r0 = ret.Get(0).(models.DependencyVulnHints)
	}
...
func (_c *DependencyVulnRepository_GetHintsInOrganizationForVuln_Call) Return(dependencyVulnHints models.DependencyVulnHints, err error) *DependencyVulnRepository_GetHintsInOrganizationForVuln_Call {
	_c.Call.Return(dependencyVulnHints, err)
	return _c
}

func (_c *DependencyVulnRepository_GetHintsInOrganizationForVuln_Call) RunAndReturn(run func(tx core.DB, orgID uuid.UUID, pURL string, cveID string) (models.DependencyVulnHints, error)) *DependencyVulnRepository_GetHintsInOrganizationForVuln_Call {
	_c.Call.Return(run)
	return _c
}
