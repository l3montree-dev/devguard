...
func (_m *DependencyVulnRepository) ListByScanner(assetVersionName string, assetID uuid.UUID, scannerID string) ([]models.DependencyVuln, error) {
...
// DependencyVulnRepository_ListByScanner_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListByScanner'
type DependencyVulnRepository_ListByScanner_Call struct {
	*mock.Call
}
...
//   - assetID uuid.UUID
//   - scannerID string
func (_e *DependencyVulnRepository_Expecter) ListByScanner(assetVersionName interface{}, assetID interface{}, scannerID interface{}) *DependencyVulnRepository_ListByScanner_Call {
	return &DependencyVulnRepository_ListByScanner_Call{Call: _e.mock.On("ListByScanner", assetVersionName, assetID, scannerID)}
}

func (_c *DependencyVulnRepository_ListByScanner_Call) Run(run func(assetVersionName string, assetID uuid.UUID, scannerID string)) *DependencyVulnRepository_ListByScanner_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DependencyVulnRepository_ListByScanner_Call) Return(_a0 []models.DependencyVuln, _a1 error) *DependencyVulnRepository_ListByScanner_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DependencyVulnRepository_ListByScanner_Call) RunAndReturn(run func(string, uuid.UUID, string) ([]models.DependencyVuln, error)) *DependencyVulnRepository_ListByScanner_Call {
	_c.Call.Return(run)
	return _c
}
