...
func (_m *DependencyVulnRepository) DeleteBatch(tx *gorm.DB, ids []models.DependencyVuln) error {
...
func (_c *DependencyVulnRepository_DeleteBatch_Call) Run(run func(tx *gorm.DB, ids []models.DependencyVuln)) *DependencyVulnRepository_DeleteBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].([]models.DependencyVuln))
	})
	return _c
...
func (_c *DependencyVulnRepository_DeleteBatch_Call) Return(_a0 error) *DependencyVulnRepository_DeleteBatch_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *DependencyVulnRepository_DeleteBatch_Call) RunAndReturn(run func(*gorm.DB, []models.DependencyVuln) error) *DependencyVulnRepository_DeleteBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetDependencyVulnsByAssetVersion provides a mock function with given fields: tx, assetVersionName, assetID, scannerID
func (_m *DependencyVulnRepository) GetDependencyVulnsByAssetVersion(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scannerID string) ([]models.DependencyVuln, error) {
	...
	var r0 []models.DependencyVuln
	var r1 error
	if rf, ok := ret.Get(0).(func(*gorm.DB, string, uuid.UUID, string) ([]models.DependencyVuln, error)); ok {
		return rf(tx, assetVersionName, assetID, scannerID)
	}
	if rf, ok := ret.Get(0).(func(*gorm.DB, string, uuid.UUID, string) []models.DependencyVuln); ok {
...
func (_c *DependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scannerID string)) *DependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call) RunAndReturn(run func(*gorm.DB, string, uuid.UUID, string) ([]models.DependencyVuln, error)) *DependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	_c.Call.Return(run)
	return _c
}
