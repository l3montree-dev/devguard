...
func (_m *ComponentRepository) GetLicenseDistribution(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scanner string) (map[string]int, error) {
...
//   - assetID uuid.UUID
//   - scanner string
func (_e *ComponentRepository_Expecter) GetLicenseDistribution(tx interface{}, assetVersionName interface{}, assetID interface{}, scanner interface{}) *ComponentRepository_GetLicenseDistribution_Call {
	return &ComponentRepository_GetLicenseDistribution_Call{Call: _e.mock.On("GetLicenseDistribution", tx, assetVersionName, assetID, scanner)}
}

func (_c *ComponentRepository_GetLicenseDistribution_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scanner string)) *ComponentRepository_GetLicenseDistribution_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *ComponentRepository) HandleStateDiff(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, oldState []models.ComponentDependency, newState []models.ComponentDependency) error {
...
func (_e *ComponentRepository_Expecter) HandleStateDiff(tx interface{}, assetVersionName interface{}, assetID interface{}, oldState interface{}, newState interface{}) *ComponentRepository_HandleStateDiff_Call {
	return &ComponentRepository_HandleStateDiff_Call{Call: _e.mock.On("HandleStateDiff", tx, assetVersionName, assetID, oldState, newState)}
}

func (_c *ComponentRepository_HandleStateDiff_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, oldState []models.ComponentDependency, newState []models.ComponentDependency)) *ComponentRepository_HandleStateDiff_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ComponentRepository_HandleStateDiff_Call) RunAndReturn(run func(*gorm.DB, string, uuid.UUID, []models.ComponentDependency, []models.ComponentDependency) error) *ComponentRepository_HandleStateDiff_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ComponentRepository) LoadComponents(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scanner string) ([]models.ComponentDependency, error) {
	ret := _m.Called(tx, assetVersionName, assetID, scanner)
...
//   - assetID uuid.UUID
//   - scanner string
func (_e *ComponentRepository_Expecter) LoadComponents(tx interface{}, assetVersionName interface{}, assetID interface{}, scanner interface{}) *ComponentRepository_LoadComponents_Call {
	return &ComponentRepository_LoadComponents_Call{Call: _e.mock.On("LoadComponents", tx, assetVersionName, assetID, scanner)}
}

func (_c *ComponentRepository_LoadComponents_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scanner string)) *ComponentRepository_LoadComponents_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].(string), args[2].(uuid.UUID), args[3].(string))
	})
	return _c
...
func (_m *ComponentRepository) LoadComponentsWithProject(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scanner string, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery) (core.Paged[models.ComponentDependency], error) {
...
//   - sort []core.SortQuery
func (_e *ComponentRepository_Expecter) LoadComponentsWithProject(tx interface{}, assetVersionName interface{}, assetID interface{}, scanner interface{}, pageInfo interface{}, search interface{}, filter interface{}, sort interface{}) *ComponentRepository_LoadComponentsWithProject_Call {
	return &ComponentRepository_LoadComponentsWithProject_Call{Call: _e.mock.On("LoadComponentsWithProject", tx, assetVersionName, assetID, scanner, pageInfo, search, filter, sort)}
}

func (_c *ComponentRepository_LoadComponentsWithProject_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scanner string, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery)) *ComponentRepository_LoadComponentsWithProject_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *ComponentRepository) LoadPathToComponent(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, pURL string, scanner string) ([]models.ComponentDependency, error) {
...
//   - pURL string
//   - scanner string
func (_e *ComponentRepository_Expecter) LoadPathToComponent(tx interface{}, assetVersionName interface{}, assetID interface{}, pURL interface{}, scanner interface{}) *ComponentRepository_LoadPathToComponent_Call {
	return &ComponentRepository_LoadPathToComponent_Call{Call: _e.mock.On("LoadPathToComponent", tx, assetVersionName, assetID, pURL, scanner)}
}

func (_c *ComponentRepository_LoadPathToComponent_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, pURL string, scanner string)) *ComponentRepository_LoadPathToComponent_Call {
	_c.Call.Run(func(args mock.Arguments) {
