...
// UpdateFirstPartyVulnState provides a mock function with given fields: tx, userID, firstPartyVuln, statusType, justification, mechanicalJustification
func (_m *FirstPartyVulnService) UpdateFirstPartyVulnState(tx *gorm.DB, userID string, firstPartyVuln *models.FirstPartyVuln, statusType string, justification string, mechanicalJustification models.MechanicalJustificationType) (models.VulnEvent, error) {
	ret := _m.Called(tx, userID, firstPartyVuln, statusType, justification, mechanicalJustification)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*gorm.DB, string, *models.FirstPartyVuln, string, string, models.MechanicalJustificationType) (models.VulnEvent, error)); ok {
		return rf(tx, userID, firstPartyVuln, statusType, justification, mechanicalJustification)
	}
	if rf, ok := ret.Get(0).(func(*gorm.DB, string, *models.FirstPartyVuln, string, string, models.MechanicalJustificationType) models.VulnEvent); ok {
		r0 = rf(tx, userID, firstPartyVuln, statusType, justification, mechanicalJustification)
	} else {
		r0 = ret.Get(0).(models.VulnEvent)
	}

	if rf, ok := ret.Get(1).(func(*gorm.DB, string, *models.FirstPartyVuln, string, string, models.MechanicalJustificationType) error); ok {
		r1 = rf(tx, userID, firstPartyVuln, statusType, justification, mechanicalJustification)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *FirstPartyVulnService_UpdateFirstPartyVulnState_Call) Run(run func(tx *gorm.DB, userID string, firstPartyVuln *models.FirstPartyVuln, statusType string, justification string, mechanicalJustification models.MechanicalJustificationType)) *FirstPartyVulnService_UpdateFirstPartyVulnState_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].(string), args[2].(*models.FirstPartyVuln), args[3].(string), args[4].(string), args[5].(models.MechanicalJustificationType))
	})
	return _c
}
...
func (_c *FirstPartyVulnService_UpdateFirstPartyVulnState_Call) RunAndReturn(run func(*gorm.DB, string, *models.FirstPartyVuln, string, string, models.MechanicalJustificationType) (models.VulnEvent, error)) *FirstPartyVulnService_UpdateFirstPartyVulnState_Call {
	_c.Call.Return(run)
	return _c
}
