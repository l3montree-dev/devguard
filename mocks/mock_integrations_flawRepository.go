...
func (_c *IntegrationsFlawRepository_FindByTicketID_Call) Run(run func(tx core.DB, ticketID string)) *IntegrationsFlawRepository_FindByTicketID_Call {
...
func (_c *IntegrationsFlawRepository_FindByTicketID_Call) RunAndReturn(run func(core.DB, string) (models.Flaw, error)) *IntegrationsFlawRepository_FindByTicketID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *IntegrationsFlawRepository) GetOrgFromFlawID(tx core.DB, flawID string) (models.Org, error) {
	...
	var r0 models.Org
	var r1 error
	if rf, ok := ret.Get(0).(func(core.DB, string) (models.Org, error)); ok {
		return rf(tx, flawID)
	}
	if rf, ok := ret.Get(0).(func(core.DB, string) models.Org); ok {
		r0 = rf(tx, flawID)
	} else {
...
func (_c *IntegrationsFlawRepository_GetOrgFromFlawID_Call) Run(run func(tx core.DB, flawID string)) *IntegrationsFlawRepository_GetOrgFromFlawID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(string))
	})
	return _c
...
func (_c *IntegrationsFlawRepository_GetOrgFromFlawID_Call) RunAndReturn(run func(core.DB, string) (models.Org, error)) *IntegrationsFlawRepository_GetOrgFromFlawID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *IntegrationsFlawRepository_Save_Call) Run(run func(db core.DB, flaw *models.Flaw)) *IntegrationsFlawRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IntegrationsFlawRepository_Save_Call) RunAndReturn(run func(core.DB, *models.Flaw) error) *IntegrationsFlawRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *IntegrationsFlawRepository_Transaction_Call) Run(run func(fn func(core.DB) error)) *IntegrationsFlawRepository_Transaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IntegrationsFlawRepository_Transaction_Call) RunAndReturn(run func(func(core.DB) error) error) *IntegrationsFlawRepository_Transaction_Call {
	_c.Call.Return(run)
	return _c
}
