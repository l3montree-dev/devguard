...
func (_m *IntegrationsDependencyVulnRepository) FindByTicketID(tx *gorm.DB, ticketID string) (models.DependencyVuln, error) {
...
func (_c *IntegrationsDependencyVulnRepository_FindByTicketID_Call) Return(_a0 models.DependencyVuln, _a1 error) *IntegrationsDependencyVulnRepository_FindByTicketID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *IntegrationsDependencyVulnRepository_FindByTicketID_Call) RunAndReturn(run func(*gorm.DB, string) (models.DependencyVuln, error)) *IntegrationsDependencyVulnRepository_FindByTicketID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *IntegrationsDependencyVulnRepository) Save(db *gorm.DB, dependencyVuln *models.DependencyVuln) error {
...
func (_c *IntegrationsDependencyVulnRepository_Save_Call) Run(run func(db *gorm.DB, dependencyVuln *models.DependencyVuln)) *IntegrationsDependencyVulnRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IntegrationsDependencyVulnRepository_Save_Call) RunAndReturn(run func(*gorm.DB, *models.DependencyVuln) error) *IntegrationsDependencyVulnRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
