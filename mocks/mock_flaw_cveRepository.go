...
func (_c *FlawCveRepository_FindCVE_Call) Run(run func(tx database.DB, cveId string)) *FlawCveRepository_FindCVE_Call {
...
func (_c *FlawCveRepository_FindCVE_Call) RunAndReturn(run func(database.DB, string) (models.CVE, error)) *FlawCveRepository_FindCVE_Call {
	_c.Call.Return(run)
	return _c
}
