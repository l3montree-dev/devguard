...
// IntegrationsGithubUserRepository is an autogenerated mock type for the githubUserRepository type
...
func (_m *IntegrationsGithubUserRepository) FindByOrgID(tx *gorm.DB, orgID uuid.UUID) ([]models.GithubUser, error) {
	...
	var r0 []models.GithubUser
	var r1 error
	if rf, ok := ret.Get(0).(func(*gorm.DB, uuid.UUID) ([]models.GithubUser, error)); ok {
		return rf(tx, orgID)
	}
	if rf, ok := ret.Get(0).(func(*gorm.DB, uuid.UUID) []models.GithubUser); ok {
		r0 = rf(tx, orgID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.GithubUser)
		}
	}
...
func (_c *IntegrationsGithubUserRepository_FindByOrgID_Call) Return(_a0 []models.GithubUser, _a1 error) *IntegrationsGithubUserRepository_FindByOrgID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *IntegrationsGithubUserRepository_FindByOrgID_Call) RunAndReturn(run func(*gorm.DB, uuid.UUID) ([]models.GithubUser, error)) *IntegrationsGithubUserRepository_FindByOrgID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *IntegrationsGithubUserRepository) Save(db *gorm.DB, user *models.GithubUser) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*gorm.DB, *models.GithubUser) error); ok {
		r0 = rf(db, user)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *IntegrationsGithubUserRepository_Save_Call) Run(run func(db *gorm.DB, user *models.GithubUser)) *IntegrationsGithubUserRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].(*models.GithubUser))
	})
	return _c
}
...
func (_c *IntegrationsGithubUserRepository_Save_Call) RunAndReturn(run func(*gorm.DB, *models.GithubUser) error) *IntegrationsGithubUserRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
