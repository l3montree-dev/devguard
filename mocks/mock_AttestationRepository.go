...
//   - tx shared.DB
//   - id string
func (_e *AttestationRepository_Expecter) Activate(ctx any, tx any, id any) *AttestationRepository_Activate_Call {
...
//   - ctx context.Context
//   - tx shared.DB
func (_e *AttestationRepository_Expecter) All(ctx any, tx any) *AttestationRepository_All_Call {
...
//   - ctx context.Context
func (_e *AttestationRepository_Expecter) Begin(ctx any) *AttestationRepository_Begin_Call {
...
func (_c *AttestationRepository_Begin_Call) Return(dB shared.DB) *AttestationRepository_Begin_Call {
	_c.Call.Return(dB)
	return _c
}
...
// CleanupOrphanedRecords provides a mock function for the type AttestationRepository
func (_mock *AttestationRepository) CleanupOrphanedRecords(ctx context.Context) error {
	ret := _mock.Called(ctx)
...
// AttestationRepository_CleanupOrphanedRecords_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CleanupOrphanedRecords'
type AttestationRepository_CleanupOrphanedRecords_Call struct {
	*mock.Call
}

// CleanupOrphanedRecords is a helper method to define mock.On call
//   - ctx context.Context
func (_e *AttestationRepository_Expecter) CleanupOrphanedRecords(ctx any) *AttestationRepository_CleanupOrphanedRecords_Call {
	return &AttestationRepository_CleanupOrphanedRecords_Call{Call: _e.mock.On("CleanupOrphanedRecords", ctx)}
}

func (_c *AttestationRepository_CleanupOrphanedRecords_Call) Run(run func(ctx context.Context)) *AttestationRepository_CleanupOrphanedRecords_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *AttestationRepository_CleanupOrphanedRecords_Call) Return(err error) *AttestationRepository_CleanupOrphanedRecords_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *AttestationRepository_CleanupOrphanedRecords_Call) RunAndReturn(run func(ctx context.Context) error) *AttestationRepository_CleanupOrphanedRecords_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *AttestationRepository_Expecter) Create(ctx any, tx any, t any) *AttestationRepository_Create_Call {
...
func (_e *AttestationRepository_Expecter) CreateBatch(ctx any, tx any, ts any) *AttestationRepository_CreateBatch_Call {
...
//   - tx shared.DB
//   - id string
func (_e *AttestationRepository_Expecter) Delete(ctx any, tx any, id any) *AttestationRepository_Delete_Call {
...
func (_e *AttestationRepository_Expecter) DeleteBatch(ctx any, tx any, ids any) *AttestationRepository_DeleteBatch_Call {
...
//   - tx shared.DB
//   - assetID uuid.UUID
func (_e *AttestationRepository_Expecter) GetByAssetID(ctx any, tx any, assetID any) *AttestationRepository_GetByAssetID_Call {
...
//   - assetID uuid.UUID
//   - assetVersion string
func (_e *AttestationRepository_Expecter) GetByAssetVersionAndAssetID(ctx any, tx any, assetID any, assetVersion any) *AttestationRepository_GetByAssetVersionAndAssetID_Call {
...
//   - ctx context.Context
//   - tx shared.DB
func (_e *AttestationRepository_Expecter) GetDB(ctx any, tx any) *AttestationRepository_GetDB_Call {
...
func (_c *AttestationRepository_GetDB_Call) Return(dB shared.DB) *AttestationRepository_GetDB_Call {
	_c.Call.Return(dB)
	return _c
}
...
// InBatches provides a mock function for the type AttestationRepository
func (_mock *AttestationRepository) InBatches(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.Attestation, error] {
	...
	var r0 iter.Seq2[[]models.Attestation, error]
	if returnFunc, ok := ret.Get(0).(func(context.Context, shared.DB, int) iter.Seq2[[]models.Attestation, error]); ok {
		r0 = returnFunc(ctx, tx, batchSize)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(iter.Seq2[[]models.Attestation, error])
		}
	}
	return r0
}

// AttestationRepository_InBatches_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InBatches'
type AttestationRepository_InBatches_Call struct {
	*mock.Call
}
...
//   - tx shared.DB
//   - batchSize int
func (_e *AttestationRepository_Expecter) InBatches(ctx any, tx any, batchSize any) *AttestationRepository_InBatches_Call {
	return &AttestationRepository_InBatches_Call{Call: _e.mock.On("InBatches", ctx, tx, batchSize)}
}

func (_c *AttestationRepository_InBatches_Call) Run(run func(ctx context.Context, tx shared.DB, batchSize int)) *AttestationRepository_InBatches_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *AttestationRepository_InBatches_Call) Return(seq2 iter.Seq2[[]models.Attestation, error]) *AttestationRepository_InBatches_Call {
	_c.Call.Return(seq2)
	return _c
}

func (_c *AttestationRepository_InBatches_Call) RunAndReturn(run func(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.Attestation, error]) *AttestationRepository_InBatches_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - tx shared.DB
//   - ids []string
func (_e *AttestationRepository_Expecter) List(ctx any, tx any, ids any) *AttestationRepository_List_Call {
...
//   - tx shared.DB
//   - id string
func (_e *AttestationRepository_Expecter) Read(ctx any, tx any, id any) *AttestationRepository_Read_Call {
...
//   - tx shared.DB
//   - t *models.Attestation
func (_e *AttestationRepository_Expecter) Save(ctx any, tx any, t any) *AttestationRepository_Save_Call {
...
//   - tx shared.DB
//   - ts []models.Attestation
func (_e *AttestationRepository_Expecter) SaveBatch(ctx any, tx any, ts any) *AttestationRepository_SaveBatch_Call {
...
func (_e *AttestationRepository_Expecter) Transaction(ctx any, fn any) *AttestationRepository_Transaction_Call {
...
//   - updateOnly []string
func (_e *AttestationRepository_Expecter) Upsert(ctx any, tx any, t any, conflictingColumns any, updateOnly any) *AttestationRepository_Upsert_Call {
