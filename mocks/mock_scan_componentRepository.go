...
func (_c *ScanComponentRepository_LoadComponents_Call) Run(run func(tx core.DB, asset models.Asset, scanType string, version string)) *ScanComponentRepository_LoadComponents_Call {
...
func (_c *ScanComponentRepository_LoadComponents_Call) RunAndReturn(run func(core.DB, models.Asset, string, string) ([]models.ComponentDependency, error)) *ScanComponentRepository_LoadComponents_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ScanComponentRepository_SaveBatch_Call) Run(run func(tx core.DB, components []models.Component)) *ScanComponentRepository_SaveBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ScanComponentRepository_SaveBatch_Call) RunAndReturn(run func(core.DB, []models.Component) error) *ScanComponentRepository_SaveBatch_Call {
	_c.Call.Return(run)
	return _c
}
