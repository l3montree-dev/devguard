...
func (_m *AssetVersionService) HandleFirstPartyVulnResult(asset models.Asset, assetVersion *models.AssetVersion, sarifScan models.SarifResult, scannerID string, userID string, doRiskManagement bool) (int, int, []models.FirstPartyVulnerability, error) {
...
func (_c *AssetVersionService_HandleFirstPartyVulnResult_Call) Run(run func(asset models.Asset, assetVersion *models.AssetVersion, sarifScan models.SarifResult, scannerID string, userID string, doRiskManagement bool)) *AssetVersionService_HandleFirstPartyVulnResult_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AssetVersionService_HandleFirstPartyVulnResult_Call) RunAndReturn(run func(models.Asset, *models.AssetVersion, models.SarifResult, string, string, bool) (int, int, []models.FirstPartyVulnerability, error)) *AssetVersionService_HandleFirstPartyVulnResult_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AssetVersionService) HandleScanResult(asset models.Asset, assetVersion *models.AssetVersion, vulns []models.VulnInPackage, scanner string, scannerID string, userID string, doRiskManagement bool) ([]models.DependencyVuln, []models.DependencyVuln, []models.DependencyVuln, error) {
	...
	var r3 error
	if rf, ok := ret.Get(0).(func(models.Asset, *models.AssetVersion, []models.VulnInPackage, string, string, string, bool) ([]models.DependencyVuln, []models.DependencyVuln, []models.DependencyVuln, error)); ok {
		return rf(asset, assetVersion, vulns, scanner, scannerID, userID, doRiskManagement)
	}
	if rf, ok := ret.Get(0).(func(models.Asset, *models.AssetVersion, []models.VulnInPackage, string, string, string, bool) []models.DependencyVuln); ok {
	...
	if rf, ok := ret.Get(1).(func(models.Asset, *models.AssetVersion, []models.VulnInPackage, string, string, string, bool) []models.DependencyVuln); ok {
...
//   - userID string
//   - doRiskManagement bool
func (_e *AssetVersionService_Expecter) HandleScanResult(asset interface{}, assetVersion interface{}, vulns interface{}, scanner interface{}, scannerID interface{}, userID interface{}, doRiskManagement interface{}) *AssetVersionService_HandleScanResult_Call {
	return &AssetVersionService_HandleScanResult_Call{Call: _e.mock.On("HandleScanResult", asset, assetVersion, vulns, scanner, scannerID, userID, doRiskManagement)}
}

func (_c *AssetVersionService_HandleScanResult_Call) Run(run func(asset models.Asset, assetVersion *models.AssetVersion, vulns []models.VulnInPackage, scanner string, scannerID string, userID string, doRiskManagement bool)) *AssetVersionService_HandleScanResult_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AssetVersionService_HandleScanResult_Call) RunAndReturn(run func(models.Asset, *models.AssetVersion, []models.VulnInPackage, string, string, string, bool) ([]models.DependencyVuln, []models.DependencyVuln, []models.DependencyVuln, error)) *AssetVersionService_HandleScanResult_Call {
	_c.Call.Return(run)
	return _c
}
