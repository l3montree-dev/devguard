...
// BuildOpenVeX provides a mock function with given fields: asset, assetVersion, version, organizationSlug, dependencyVulns
func (_m *AssetVersionService) BuildOpenVeX(asset models.Asset, assetVersion models.AssetVersion, version string, organizationSlug string, dependencyVulns []models.DependencyVuln) vex.VEX {
	ret := _m.Called(asset, assetVersion, version, organizationSlug, dependencyVulns)
	...
	var r0 vex.VEX
	if rf, ok := ret.Get(0).(func(models.Asset, models.AssetVersion, string, string, []models.DependencyVuln) vex.VEX); ok {
		r0 = rf(asset, assetVersion, version, organizationSlug, dependencyVulns)
	} else {
...
func (_e *AssetVersionService_Expecter) BuildOpenVeX(asset interface{}, assetVersion interface{}, version interface{}, organizationSlug interface{}, dependencyVulns interface{}) *AssetVersionService_BuildOpenVeX_Call {
	return &AssetVersionService_BuildOpenVeX_Call{Call: _e.mock.On("BuildOpenVeX", asset, assetVersion, version, organizationSlug, dependencyVulns)}
}

func (_c *AssetVersionService_BuildOpenVeX_Call) Run(run func(asset models.Asset, assetVersion models.AssetVersion, version string, organizationSlug string, dependencyVulns []models.DependencyVuln)) *AssetVersionService_BuildOpenVeX_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(models.Asset), args[1].(models.AssetVersion), args[2].(string), args[3].(string), args[4].([]models.DependencyVuln))
	})
	return _c
}

func (_c *AssetVersionService_BuildOpenVeX_Call) Return(_a0 vex.VEX) *AssetVersionService_BuildOpenVeX_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AssetVersionService_BuildOpenVeX_Call) RunAndReturn(run func(models.Asset, models.AssetVersion, string, string, []models.DependencyVuln) vex.VEX) *AssetVersionService_BuildOpenVeX_Call {
	_c.Call.Return(run)
	return _c
}
...
// BuildVeX provides a mock function with given fields: asset, assetVersion, version, orgName, dependencyVulns
func (_m *AssetVersionService) BuildVeX(asset models.Asset, assetVersion models.AssetVersion, version string, orgName string, dependencyVulns []models.DependencyVuln) *cyclonedx.BOM {
	ret := _m.Called(asset, assetVersion, version, orgName, dependencyVulns)
	...
	var r0 *cyclonedx.BOM
	if rf, ok := ret.Get(0).(func(models.Asset, models.AssetVersion, string, string, []models.DependencyVuln) *cyclonedx.BOM); ok {
		r0 = rf(asset, assetVersion, version, orgName, dependencyVulns)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cyclonedx.BOM)
		}
...
//   - orgName string
//   - dependencyVulns []models.DependencyVuln
func (_e *AssetVersionService_Expecter) BuildVeX(asset interface{}, assetVersion interface{}, version interface{}, orgName interface{}, dependencyVulns interface{}) *AssetVersionService_BuildVeX_Call {
	return &AssetVersionService_BuildVeX_Call{Call: _e.mock.On("BuildVeX", asset, assetVersion, version, orgName, dependencyVulns)}
}

func (_c *AssetVersionService_BuildVeX_Call) Run(run func(asset models.Asset, assetVersion models.AssetVersion, version string, orgName string, dependencyVulns []models.DependencyVuln)) *AssetVersionService_BuildVeX_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(models.Asset), args[1].(models.AssetVersion), args[2].(string), args[3].(string), args[4].([]models.DependencyVuln))
	})
	return _c
...
func (_c *AssetVersionService_BuildVeX_Call) RunAndReturn(run func(models.Asset, models.AssetVersion, string, string, []models.DependencyVuln) *cyclonedx.BOM) *AssetVersionService_BuildVeX_Call {
	_c.Call.Return(run)
	return _c
}
