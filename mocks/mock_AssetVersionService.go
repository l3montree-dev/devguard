...
// BuildOpenVeX provides a mock function with given fields: asset, assetVersion, organizationSlug, dependencyVulns
func (_m *AssetVersionService) BuildOpenVeX(asset models.Asset, assetVersion models.AssetVersion, organizationSlug string, dependencyVulns []models.DependencyVuln) vex.VEX {
	ret := _m.Called(asset, assetVersion, organizationSlug, dependencyVulns)
	...
	var r0 vex.VEX
	if rf, ok := ret.Get(0).(func(models.Asset, models.AssetVersion, string, []models.DependencyVuln) vex.VEX); ok {
		r0 = rf(asset, assetVersion, organizationSlug, dependencyVulns)
	} else {
...
func (_c *AssetVersionService_BuildOpenVeX_Call) Run(run func(asset models.Asset, assetVersion models.AssetVersion, organizationSlug string, dependencyVulns []models.DependencyVuln)) *AssetVersionService_BuildOpenVeX_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(models.Asset), args[1].(models.AssetVersion), args[2].(string), args[3].([]models.DependencyVuln))
	})
	return _c
}
...
func (_c *AssetVersionService_BuildOpenVeX_Call) RunAndReturn(run func(models.Asset, models.AssetVersion, string, []models.DependencyVuln) vex.VEX) *AssetVersionService_BuildOpenVeX_Call {
	_c.Call.Return(run)
	return _c
}
...
// BuildVeX provides a mock function with given fields: asset, assetVersion, orgName, dependencyVulns
func (_m *AssetVersionService) BuildVeX(asset models.Asset, assetVersion models.AssetVersion, orgName string, dependencyVulns []models.DependencyVuln) *cyclonedx.BOM {
	ret := _m.Called(asset, assetVersion, orgName, dependencyVulns)
	...
	var r0 *cyclonedx.BOM
	if rf, ok := ret.Get(0).(func(models.Asset, models.AssetVersion, string, []models.DependencyVuln) *cyclonedx.BOM); ok {
		r0 = rf(asset, assetVersion, orgName, dependencyVulns)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cyclonedx.BOM)
		}
...
func (_c *AssetVersionService_BuildVeX_Call) RunAndReturn(run func(models.Asset, models.AssetVersion, string, []models.DependencyVuln) *cyclonedx.BOM) *AssetVersionService_BuildVeX_Call {
	_c.Call.Return(run)
	return _c
}
