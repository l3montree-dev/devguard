...
func (_mock *AssetVersionService) BuildOpenVeX(asset models.Asset, assetVersion models.AssetVersion, version string, organizationSlug string, dependencyVulns []models.DependencyVuln) vex.VEX {
	ret := _mock.Called(asset, assetVersion, version, organizationSlug, dependencyVulns)
	...
	var r0 vex.VEX
	if returnFunc, ok := ret.Get(0).(func(models.Asset, models.AssetVersion, string, string, []models.DependencyVuln) vex.VEX); ok {
		r0 = returnFunc(asset, assetVersion, version, organizationSlug, dependencyVulns)
	} else {
...
func (_c *AssetVersionService_BuildOpenVeX_Call) RunAndReturn(run func(asset models.Asset, assetVersion models.AssetVersion, version string, organizationSlug string, dependencyVulns []models.DependencyVuln) vex.VEX) *AssetVersionService_BuildOpenVeX_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *AssetVersionService) BuildVeX(asset models.Asset, assetVersion models.AssetVersion, version string, orgName string, components []models.ComponentDependency, dependencyVulns []models.DependencyVuln) *cyclonedx.BOM {
	ret := _mock.Called(asset, assetVersion, version, orgName, components, dependencyVulns)
	...
	var r0 *cyclonedx.BOM
	if returnFunc, ok := ret.Get(0).(func(models.Asset, models.AssetVersion, string, string, []models.ComponentDependency, []models.DependencyVuln) *cyclonedx.BOM); ok {
		r0 = returnFunc(asset, assetVersion, version, orgName, components, dependencyVulns)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cyclonedx.BOM)
		}
...
func (_c *AssetVersionService_BuildVeX_Call) RunAndReturn(run func(asset models.Asset, assetVersion models.AssetVersion, version string, orgName string, components []models.ComponentDependency, dependencyVulns []models.DependencyVuln) *cyclonedx.BOM) *AssetVersionService_BuildVeX_Call {
	_c.Call.Return(run)
	return _c
}
