...
func (_m *DependencyVulnAssetRepository) Update(tx *gorm.DB, asset *models.Asset) error {
...
// DependencyVulnAssetRepository_Update_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Update'
type DependencyVulnAssetRepository_Update_Call struct {
	*mock.Call
}
...
//   - tx *gorm.DB
//   - asset *models.Asset
func (_e *DependencyVulnAssetRepository_Expecter) Update(tx interface{}, asset interface{}) *DependencyVulnAssetRepository_Update_Call {
	return &DependencyVulnAssetRepository_Update_Call{Call: _e.mock.On("Update", tx, asset)}
}

func (_c *DependencyVulnAssetRepository_Update_Call) Run(run func(tx *gorm.DB, asset *models.Asset)) *DependencyVulnAssetRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DependencyVulnAssetRepository_Update_Call) Return(_a0 error) *DependencyVulnAssetRepository_Update_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *DependencyVulnAssetRepository_Update_Call) RunAndReturn(run func(*gorm.DB, *models.Asset) error) *DependencyVulnAssetRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
