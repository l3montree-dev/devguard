...
func (_m *CoreThirdPartyIntegration) UpdateIssue(ctx context.Context, asset models.Asset, repoId string, dependencyVuln models.DependencyVuln) error {
...
// CoreThirdPartyIntegration_UpdateIssue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateIssue'
type CoreThirdPartyIntegration_UpdateIssue_Call struct {
	*mock.Call
}
...
//   - repoId string
//   - dependencyVuln models.DependencyVuln
func (_e *CoreThirdPartyIntegration_Expecter) UpdateIssue(ctx interface{}, asset interface{}, repoId interface{}, dependencyVuln interface{}) *CoreThirdPartyIntegration_UpdateIssue_Call {
	return &CoreThirdPartyIntegration_UpdateIssue_Call{Call: _e.mock.On("UpdateIssue", ctx, asset, repoId, dependencyVuln)}
}

func (_c *CoreThirdPartyIntegration_UpdateIssue_Call) Run(run func(ctx context.Context, asset models.Asset, repoId string, dependencyVuln models.DependencyVuln)) *CoreThirdPartyIntegration_UpdateIssue_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CoreThirdPartyIntegration_UpdateIssue_Call) Return(_a0 error) *CoreThirdPartyIntegration_UpdateIssue_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CoreThirdPartyIntegration_UpdateIssue_Call) RunAndReturn(run func(context.Context, models.Asset, string, models.DependencyVuln) error) *CoreThirdPartyIntegration_UpdateIssue_Call {
	_c.Call.Return(run)
	return _c
}
