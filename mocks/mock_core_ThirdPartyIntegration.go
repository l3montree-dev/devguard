...
func (_m *CoreThirdPartyIntegration) CloseIssueAsFixed(ctx context.Context, asset models.Asset, assetVersionName string, repoId string, dependencyVuln models.DependencyVuln, projectSlug string, orgSlug string) error {
...
// CoreThirdPartyIntegration_CloseIssueAsFixed_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CloseIssueAsFixed'
type CoreThirdPartyIntegration_CloseIssueAsFixed_Call struct {
	*mock.Call
}
...
//   - projectSlug string
//   - orgSlug string
func (_e *CoreThirdPartyIntegration_Expecter) CloseIssueAsFixed(ctx interface{}, asset interface{}, assetVersionName interface{}, repoId interface{}, dependencyVuln interface{}, projectSlug interface{}, orgSlug interface{}) *CoreThirdPartyIntegration_CloseIssueAsFixed_Call {
	return &CoreThirdPartyIntegration_CloseIssueAsFixed_Call{Call: _e.mock.On("CloseIssueAsFixed", ctx, asset, assetVersionName, repoId, dependencyVuln, projectSlug, orgSlug)}
}

func (_c *CoreThirdPartyIntegration_CloseIssueAsFixed_Call) Run(run func(ctx context.Context, asset models.Asset, assetVersionName string, repoId string, dependencyVuln models.DependencyVuln, projectSlug string, orgSlug string)) *CoreThirdPartyIntegration_CloseIssueAsFixed_Call {
...
func (_c *CoreThirdPartyIntegration_CloseIssueAsFixed_Call) Return(_a0 error) *CoreThirdPartyIntegration_CloseIssueAsFixed_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CoreThirdPartyIntegration_CloseIssueAsFixed_Call) RunAndReturn(run func(context.Context, models.Asset, string, string, models.DependencyVuln, string, string) error) *CoreThirdPartyIntegration_CloseIssueAsFixed_Call {
	_c.Call.Return(run)
	return _c
}
