...
func (_c *FlawFlawService_UpdateFlawState_Call) RunAndReturn(run func(core.DB, string, *models.Flaw, string, string) (models.FlawEvent, error)) *FlawFlawService_UpdateFlawState_Call {
	_c.Call.Return(run)
	return _c
}
