...
// GetOrg provides a mock function for the type IntegrationAggregate
func (_mock *IntegrationAggregate) GetOrg(ctx context.Context, userID string, providerID string, groupID string) (models.Org, error) {
...
// IntegrationAggregate_GetOrg_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetOrg'
type IntegrationAggregate_GetOrg_Call struct {
	*mock.Call
}
...
//   - providerID
//   - groupID
func (_e *IntegrationAggregate_Expecter) GetOrg(ctx interface{}, userID interface{}, providerID interface{}, groupID interface{}) *IntegrationAggregate_GetOrg_Call {
	return &IntegrationAggregate_GetOrg_Call{Call: _e.mock.On("GetOrg", ctx, userID, providerID, groupID)}
}

func (_c *IntegrationAggregate_GetOrg_Call) Run(run func(ctx context.Context, userID string, providerID string, groupID string)) *IntegrationAggregate_GetOrg_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IntegrationAggregate_GetOrg_Call) Return(org models.Org, err error) *IntegrationAggregate_GetOrg_Call {
	_c.Call.Return(org, err)
	return _c
}

func (_c *IntegrationAggregate_GetOrg_Call) RunAndReturn(run func(ctx context.Context, userID string, providerID string, groupID string) (models.Org, error)) *IntegrationAggregate_GetOrg_Call {
	_c.Call.Return(run)
	return _c
}
