...
func (_c *StatisticsFlawRepository_GetAllFlawsByAssetID_Call) Run(run func(tx core.DB, assetID uuid.UUID)) *StatisticsFlawRepository_GetAllFlawsByAssetID_Call {
...
func (_c *StatisticsFlawRepository_GetAllFlawsByAssetID_Call) RunAndReturn(run func(core.DB, uuid.UUID) ([]models.Flaw, error)) *StatisticsFlawRepository_GetAllFlawsByAssetID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *StatisticsFlawRepository_GetAllOpenFlawsByAssetID_Call) Run(run func(tx core.DB, assetID uuid.UUID)) *StatisticsFlawRepository_GetAllOpenFlawsByAssetID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(uuid.UUID))
	})
	return _c
...
func (_c *StatisticsFlawRepository_GetAllOpenFlawsByAssetID_Call) RunAndReturn(run func(core.DB, uuid.UUID) ([]models.Flaw, error)) *StatisticsFlawRepository_GetAllOpenFlawsByAssetID_Call {
	_c.Call.Return(run)
	return _c
}
