...
func (_m *IntegrationsGithubAppInstallationRepository) Delete(tx core.DB, installationID int) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, int) error); ok {
...
func (_c *IntegrationsGithubAppInstallationRepository_Delete_Call) Run(run func(tx core.DB, installationID int)) *IntegrationsGithubAppInstallationRepository_Delete_Call {
...
func (_c *IntegrationsGithubAppInstallationRepository_Delete_Call) RunAndReturn(run func(core.DB, int) error) *IntegrationsGithubAppInstallationRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *IntegrationsGithubAppInstallationRepository) Save(tx core.DB, model *models.GithubAppInstallation) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, *models.GithubAppInstallation) error); ok {
		r0 = rf(tx, model)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *IntegrationsGithubAppInstallationRepository_Save_Call) Run(run func(tx core.DB, model *models.GithubAppInstallation)) *IntegrationsGithubAppInstallationRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IntegrationsGithubAppInstallationRepository_Save_Call) RunAndReturn(run func(core.DB, *models.GithubAppInstallation) error) *IntegrationsGithubAppInstallationRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
