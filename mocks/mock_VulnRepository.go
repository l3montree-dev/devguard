...
func (_c *VulnRepository_FindByTicketID_Call) Run(run func(tx *gorm.DB, ticketID string)) *VulnRepository_FindByTicketID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *VulnRepository_FindByTicketID_Call) Return(_a0 models.Vuln, _a1 error) *VulnRepository_FindByTicketID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *VulnRepository_FindByTicketID_Call) RunAndReturn(run func(*gorm.DB, string) (models.Vuln, error)) *VulnRepository_FindByTicketID_Call {
	_c.Call.Return(run)
	return _c
}

// GetOrgFromVuln provides a mock function with given fields: vuln
func (_m *VulnRepository) GetOrgFromVuln(vuln models.Vuln) (models.Org, error) {
	ret := _m.Called(vuln)
...
func (_c *VulnRepository_GetOrgFromVuln_Call) Return(_a0 models.Org, _a1 error) *VulnRepository_GetOrgFromVuln_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *VulnRepository_GetOrgFromVuln_Call) RunAndReturn(run func(models.Vuln) (models.Org, error)) *VulnRepository_GetOrgFromVuln_Call {
	_c.Call.Return(run)
	return _c
}

// Save provides a mock function with given fields: db, vuln
func (_m *VulnRepository) Save(db *gorm.DB, vuln *models.Vuln) error {
...
func (_c *VulnRepository_Save_Call) Run(run func(db *gorm.DB, vuln *models.Vuln)) *VulnRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *VulnRepository_Save_Call) RunAndReturn(run func(*gorm.DB, *models.Vuln) error) *VulnRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}

// Transaction provides a mock function with given fields: fn
func (_m *VulnRepository) Transaction(fn func(*gorm.DB) error) error {
	ret := _m.Called(fn)
...
func (_c *VulnRepository_Transaction_Call) Run(run func(fn func(*gorm.DB) error)) *VulnRepository_Transaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
