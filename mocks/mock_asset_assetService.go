...
// BuildVeX provides a mock function with given fields: _a0, version, orgName, components, vulns
func (_m *AssetAssetService) BuildVeX(_a0 models.Asset, version string, orgName string, components []models.ComponentDependency, vulns []models.DependencyVulnerability) *cyclonedx.BOM {
	ret := _m.Called(_a0, version, orgName, components, vulns)
	...
	if rf, ok := ret.Get(0).(func(models.Asset, string, string, []models.ComponentDependency, []models.DependencyVulnerability) *cyclonedx.BOM); ok {
		r0 = rf(_a0, version, orgName, components, vulns)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cyclonedx.BOM)
		}
...
//   - components []models.ComponentDependency
//   - vulns []models.Vuln
func (_e *AssetAssetService_Expecter) BuildVeX(_a0 interface{}, version interface{}, orgName interface{}, components interface{}, vulns interface{}) *AssetAssetService_BuildVeX_Call {
	return &AssetAssetService_BuildVeX_Call{Call: _e.mock.On("BuildVeX", _a0, version, orgName, components, vulns)}
}

func (_c *AssetAssetService_BuildVeX_Call) Run(run func(_a0 models.Asset, version string, orgName string, components []models.ComponentDependency, vulns []models.DependencyVulnerability)) *AssetAssetService_BuildVeX_Call {
	_c.Call.Run(func(args mock.Arguments) {
