...
func (_c *FlawFlawRepository_Begin_Call) Return(_a0 core.DB) *FlawFlawRepository_Begin_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *FlawFlawRepository_Begin_Call) RunAndReturn(run func() core.DB) *FlawFlawRepository_Begin_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawFlawRepository_GetAllFlawsByAssetID_Call) Run(run func(tx core.DB, assetID uuid.UUID)) *FlawFlawRepository_GetAllFlawsByAssetID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FlawFlawRepository_GetAllFlawsByAssetID_Call) RunAndReturn(run func(core.DB, uuid.UUID) ([]models.Flaw, error)) *FlawFlawRepository_GetAllFlawsByAssetID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawFlawRepository_Save_Call) Run(run func(db core.DB, flaws *models.Flaw)) *FlawFlawRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FlawFlawRepository_Save_Call) RunAndReturn(run func(core.DB, *models.Flaw) error) *FlawFlawRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawFlawRepository_SaveBatch_Call) Run(run func(db core.DB, flaws []models.Flaw)) *FlawFlawRepository_SaveBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].([]models.Flaw))
	})
	return _c
...
func (_c *FlawFlawRepository_SaveBatch_Call) RunAndReturn(run func(core.DB, []models.Flaw) error) *FlawFlawRepository_SaveBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawFlawRepository_Transaction_Call) Run(run func(txFunc func(core.DB) error)) *FlawFlawRepository_Transaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FlawFlawRepository_Transaction_Call) RunAndReturn(run func(func(core.DB) error) error) *FlawFlawRepository_Transaction_Call {
	_c.Call.Return(run)
	return _c
}
