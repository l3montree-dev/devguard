...
func (_m *DependencyVulnDependencyVulnRepository) GetAllVulnsByAssetID(tx *gorm.DB, assetID uuid.UUID) ([]models.DependencyVuln, error) {
...
func (_c *DependencyVulnDependencyVulnRepository_GetAllVulnsByAssetID_Call) Return(_a0 []models.DependencyVuln, _a1 error) *DependencyVulnDependencyVulnRepository_GetAllVulnsByAssetID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DependencyVulnDependencyVulnRepository_GetAllVulnsByAssetID_Call) RunAndReturn(run func(*gorm.DB, uuid.UUID) ([]models.DependencyVuln, error)) *DependencyVulnDependencyVulnRepository_GetAllVulnsByAssetID_Call {
	_c.Call.Return(run)
	return _c
}

// GetDependencyVulnsByAssetVersion provides a mock function with given fields: tx, assetVersionName, assetID
func (_m *DependencyVulnDependencyVulnRepository) GetDependencyVulnsByAssetVersion(tx *gorm.DB, assetVersionName string, assetID uuid.UUID) ([]models.DependencyVuln, error) {
...
// DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDependencyVulnsByAssetVersion'
type DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call struct {
	*mock.Call
}
...
//   - assetID uuid.UUID
func (_e *DependencyVulnDependencyVulnRepository_Expecter) GetDependencyVulnsByAssetVersion(tx interface{}, assetVersionName interface{}, assetID interface{}) *DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	return &DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call{Call: _e.mock.On("GetDependencyVulnsByAssetVersion", tx, assetVersionName, assetID)}
}

func (_c *DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID)) *DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call) Return(_a0 []models.DependencyVuln, _a1 error) *DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call) RunAndReturn(run func(*gorm.DB, string, uuid.UUID) ([]models.DependencyVuln, error)) *DependencyVulnDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	_c.Call.Return(run)
	return _c
}
