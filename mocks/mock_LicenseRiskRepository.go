...
// InBatches provides a mock function for the type LicenseRiskRepository
func (_mock *LicenseRiskRepository) InBatches(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.LicenseRisk, error] {
	...
	var r0 iter.Seq2[[]models.LicenseRisk, error]
	if returnFunc, ok := ret.Get(0).(func(context.Context, shared.DB, int) iter.Seq2[[]models.LicenseRisk, error]); ok {
		r0 = returnFunc(ctx, tx, batchSize)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(iter.Seq2[[]models.LicenseRisk, error])
		}
	}
	return r0
}

// LicenseRiskRepository_InBatches_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InBatches'
type LicenseRiskRepository_InBatches_Call struct {
	*mock.Call
}
...
func (_c *LicenseRiskRepository_InBatches_Call) Run(run func(ctx context.Context, tx shared.DB, batchSize int)) *LicenseRiskRepository_InBatches_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *LicenseRiskRepository_InBatches_Call) Return(seq2 iter.Seq2[[]models.LicenseRisk, error]) *LicenseRiskRepository_InBatches_Call {
	_c.Call.Return(seq2)
	return _c
}

func (_c *LicenseRiskRepository_InBatches_Call) RunAndReturn(run func(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.LicenseRisk, error]) *LicenseRiskRepository_InBatches_Call {
	_c.Call.Return(run)
	return _c
}
