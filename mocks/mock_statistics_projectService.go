...
func (_m *StatisticsProjectService) ListAllowedProjects(c core.Context) ([]models.Project, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(core.Context) ([]models.Project, error)); ok {
		return rf(c)
	}
	if rf, ok := ret.Get(0).(func(core.Context) []models.Project); ok {
		r0 = rf(c)
	} else {
		if ret.Get(0) != nil {
...
func (_c *StatisticsProjectService_ListAllowedProjects_Call) Run(run func(c core.Context)) *StatisticsProjectService_ListAllowedProjects_Call {
...
func (_c *StatisticsProjectService_ListAllowedProjects_Call) RunAndReturn(run func(core.Context) ([]models.Project, error)) *StatisticsProjectService_ListAllowedProjects_Call {
	_c.Call.Return(run)
	return _c
}
