...
func (_m *ProjectProjectRepository) GetByOrgID(organizationID uuid.UUID) ([]models.Project, error) {
...
// ProjectProjectRepository_GetByOrgID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetByOrgID'
type ProjectProjectRepository_GetByOrgID_Call struct {
	*mock.Call
}

// GetByOrgID is a helper method to define mock.On call
//   - organizationID uuid.UUID
func (_e *ProjectProjectRepository_Expecter) GetByOrgID(organizationID interface{}) *ProjectProjectRepository_GetByOrgID_Call {
	return &ProjectProjectRepository_GetByOrgID_Call{Call: _e.mock.On("GetByOrgID", organizationID)}
}

func (_c *ProjectProjectRepository_GetByOrgID_Call) Run(run func(organizationID uuid.UUID)) *ProjectProjectRepository_GetByOrgID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProjectProjectRepository_GetByOrgID_Call) Return(_a0 []models.Project, _a1 error) *ProjectProjectRepository_GetByOrgID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ProjectProjectRepository_GetByOrgID_Call) RunAndReturn(run func(uuid.UUID) ([]models.Project, error)) *ProjectProjectRepository_GetByOrgID_Call {
	_c.Call.Return(run)
	return _c
}
