...
func (_mock *Verifier) VerifyAPIToken(ctx context.Context, token string) (shared.AuthSession, error) {
...
func (_c *Verifier_VerifyAPIToken_Call) Return(authSession shared.AuthSession, err error) *Verifier_VerifyAPIToken_Call {
	_c.Call.Return(authSession, err)
	return _c
}

func (_c *Verifier_VerifyAPIToken_Call) RunAndReturn(run func(ctx context.Context, token string) (shared.AuthSession, error)) *Verifier_VerifyAPIToken_Call {
	_c.Call.Return(run)
	return _c
}
