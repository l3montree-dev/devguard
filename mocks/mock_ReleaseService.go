...
// FindOrCreate provides a mock function for the type ReleaseService
func (_mock *ReleaseService) FindOrCreate(ctx context.Context, projectID uuid.UUID, name string) (models.Release, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, string) (models.Release, error)); ok {
		return returnFunc(ctx, projectID, name)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, string) models.Release); ok {
...
// ReleaseService_FindOrCreate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindOrCreate'
type ReleaseService_FindOrCreate_Call struct {
	*mock.Call
}
...
func (_c *ReleaseService_FindOrCreate_Call) Run(run func(ctx context.Context, projectID uuid.UUID, name string)) *ReleaseService_FindOrCreate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *ReleaseService_FindOrCreate_Call) Return(release models.Release, err error) *ReleaseService_FindOrCreate_Call {
	_c.Call.Return(release, err)
	return _c
}

func (_c *ReleaseService_FindOrCreate_Call) RunAndReturn(run func(ctx context.Context, projectID uuid.UUID, name string) (models.Release, error)) *ReleaseService_FindOrCreate_Call {
	_c.Call.Return(run)
	return _c
}
