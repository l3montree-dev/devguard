...
func (_c *FlawFlawEventRepository_Save_Call) Run(run func(db core.DB, event *models.FlawEvent)) *FlawFlawEventRepository_Save_Call {
...
func (_c *FlawFlawEventRepository_Save_Call) RunAndReturn(run func(core.DB, *models.FlawEvent) error) *FlawFlawEventRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawFlawEventRepository_SaveBatch_Call) Run(run func(db core.DB, events []models.FlawEvent)) *FlawFlawEventRepository_SaveBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].([]models.FlawEvent))
	})
	return _c
...
func (_c *FlawFlawEventRepository_SaveBatch_Call) RunAndReturn(run func(core.DB, []models.FlawEvent) error) *FlawFlawEventRepository_SaveBatch_Call {
	_c.Call.Return(run)
	return _c
}
