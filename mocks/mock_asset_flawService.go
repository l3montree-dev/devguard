...
func (_m *AssetFlawService) RecalculateRawRiskAssessment(tx core.DB, userID string, flaws []models.Flaw, justification string, _a4 models.Asset) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, string, []models.Flaw, string, models.Asset) error); ok {
...
func (_c *AssetFlawService_RecalculateRawRiskAssessment_Call) Run(run func(tx core.DB, userID string, flaws []models.Flaw, justification string, _a4 models.Asset)) *AssetFlawService_RecalculateRawRiskAssessment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(string), args[2].([]models.Flaw), args[3].(string), args[4].(models.Asset))
	})
	return _c
}
...
func (_c *AssetFlawService_RecalculateRawRiskAssessment_Call) RunAndReturn(run func(core.DB, string, []models.Flaw, string, models.Asset) error) *AssetFlawService_RecalculateRawRiskAssessment_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AssetFlawService) UpdateFlawState(tx core.DB, userID string, flaw *models.Flaw, statusType string, justification string) (models.FlawEvent, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(core.DB, string, *models.Flaw, string, string) (models.FlawEvent, error)); ok {
		return rf(tx, userID, flaw, statusType, justification)
	}
	if rf, ok := ret.Get(0).(func(core.DB, string, *models.Flaw, string, string) models.FlawEvent); ok {
		r0 = rf(tx, userID, flaw, statusType, justification)
	} else {
		r0 = ret.Get(0).(models.FlawEvent)
	}

	if rf, ok := ret.Get(1).(func(core.DB, string, *models.Flaw, string, string) error); ok {
...
func (_c *AssetFlawService_UpdateFlawState_Call) Run(run func(tx core.DB, userID string, flaw *models.Flaw, statusType string, justification string)) *AssetFlawService_UpdateFlawState_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(string), args[2].(*models.Flaw), args[3].(string), args[4].(string))
	})
	return _c
}
...
func (_c *AssetFlawService_UpdateFlawState_Call) RunAndReturn(run func(core.DB, string, *models.Flaw, string, string) (models.FlawEvent, error)) *AssetFlawService_UpdateFlawState_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AssetFlawService) UserDetectedFlaws(tx core.DB, userID string, flaws []models.Flaw, _a3 models.Asset, doRiskManagement bool) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, string, []models.Flaw, models.Asset, bool) error); ok {
...
func (_c *AssetFlawService_UserDetectedFlaws_Call) Run(run func(tx core.DB, userID string, flaws []models.Flaw, _a3 models.Asset, doRiskManagement bool)) *AssetFlawService_UserDetectedFlaws_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(string), args[2].([]models.Flaw), args[3].(models.Asset), args[4].(bool))
	})
	return _c
}
...
func (_c *AssetFlawService_UserDetectedFlaws_Call) RunAndReturn(run func(core.DB, string, []models.Flaw, models.Asset, bool) error) *AssetFlawService_UserDetectedFlaws_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AssetFlawService) UserFixedFlaws(tx core.DB, userID string, flaws []models.Flaw, doRiskManagement bool) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, string, []models.Flaw, bool) error); ok {
...
func (_c *AssetFlawService_UserFixedFlaws_Call) Run(run func(tx core.DB, userID string, flaws []models.Flaw, doRiskManagement bool)) *AssetFlawService_UserFixedFlaws_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(string), args[2].([]models.Flaw), args[3].(bool))
	})
	return _c
}
...
func (_c *AssetFlawService_UserFixedFlaws_Call) RunAndReturn(run func(core.DB, string, []models.Flaw, bool) error) *AssetFlawService_UserFixedFlaws_Call {
	_c.Call.Return(run)
	return _c
}
