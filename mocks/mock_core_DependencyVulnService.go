...
func (_m *CoreDependencyVulnService) ApplyAndSave(tx *gorm.DB, vuln *models.DependencyVuln, VulnEvent *models.VulnEvent) error {
...
// CoreDependencyVulnService_ApplyAndSave_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ApplyAndSave'
type CoreDependencyVulnService_ApplyAndSave_Call struct {
	*mock.Call
}
...
func (_e *CoreDependencyVulnService_Expecter) ApplyAndSave(tx interface{}, vuln interface{}, VulnEvent interface{}) *CoreDependencyVulnService_ApplyAndSave_Call {
	return &CoreDependencyVulnService_ApplyAndSave_Call{Call: _e.mock.On("ApplyAndSave", tx, vuln, VulnEvent)}
}

func (_c *CoreDependencyVulnService_ApplyAndSave_Call) Run(run func(tx *gorm.DB, vuln *models.DependencyVuln, VulnEvent *models.VulnEvent)) *CoreDependencyVulnService_ApplyAndSave_Call {
...
func (_c *CoreDependencyVulnService_ApplyAndSave_Call) Return(_a0 error) *CoreDependencyVulnService_ApplyAndSave_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CoreDependencyVulnService_ApplyAndSave_Call) RunAndReturn(run func(*gorm.DB, *models.DependencyVuln, *models.VulnEvent) error) *CoreDependencyVulnService_ApplyAndSave_Call {
	_c.Call.Return(run)
	return _c
}
