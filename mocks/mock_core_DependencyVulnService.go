...
func (_m *CoreDependencyVulnService) SyncTickets(assetVersion models.Asset) error {
	ret := _m.Called(assetVersion)
...
// CoreDependencyVulnService_SyncTickets_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SyncTickets'
type CoreDependencyVulnService_SyncTickets_Call struct {
	*mock.Call
}

// SyncTickets is a helper method to define mock.On call
//   - assetVersion models.Asset
func (_e *CoreDependencyVulnService_Expecter) SyncTickets(assetVersion interface{}) *CoreDependencyVulnService_SyncTickets_Call {
	return &CoreDependencyVulnService_SyncTickets_Call{Call: _e.mock.On("SyncTickets", assetVersion)}
}

func (_c *CoreDependencyVulnService_SyncTickets_Call) Run(run func(assetVersion models.Asset)) *CoreDependencyVulnService_SyncTickets_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CoreDependencyVulnService_SyncTickets_Call) Return(_a0 error) *CoreDependencyVulnService_SyncTickets_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CoreDependencyVulnService_SyncTickets_Call) RunAndReturn(run func(models.Asset) error) *CoreDependencyVulnService_SyncTickets_Call {
	_c.Call.Return(run)
	return _c
}
