...
func (_c *OrgInvitationRepository_Delete_Call) Run(run func(tx core.DB, id uuid.UUID)) *OrgInvitationRepository_Delete_Call {
...
func (_c *OrgInvitationRepository_Delete_Call) RunAndReturn(run func(core.DB, uuid.UUID) error) *OrgInvitationRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *OrgInvitationRepository) Save(tx core.DB, invitation *models.Invitation) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, *models.Invitation) error); ok {
		r0 = rf(tx, invitation)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *OrgInvitationRepository_Save_Call) Run(run func(tx core.DB, invitation *models.Invitation)) *OrgInvitationRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *OrgInvitationRepository_Save_Call) RunAndReturn(run func(core.DB, *models.Invitation) error) *OrgInvitationRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
