...
func (_m *CoreAuthSession) GetScopes() []string {
	ret := _m.Called()
...
// CoreAuthSession_GetScopes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetScopes'
type CoreAuthSession_GetScopes_Call struct {
	*mock.Call
}

// GetScopes is a helper method to define mock.On call
func (_e *CoreAuthSession_Expecter) GetScopes() *CoreAuthSession_GetScopes_Call {
	return &CoreAuthSession_GetScopes_Call{Call: _e.mock.On("GetScopes")}
}

func (_c *CoreAuthSession_GetScopes_Call) Run(run func()) *CoreAuthSession_GetScopes_Call {
...
func (_c *CoreAuthSession_GetScopes_Call) Return(_a0 []string) *CoreAuthSession_GetScopes_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CoreAuthSession_GetScopes_Call) RunAndReturn(run func() []string) *CoreAuthSession_GetScopes_Call {
	_c.Call.Return(run)
	return _c
}
