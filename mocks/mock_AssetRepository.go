...
func (_m *AssetRepository) DeleteBatch(tx *gorm.DB, ids []models.Asset) error {
...
func (_c *AssetRepository_DeleteBatch_Call) Run(run func(tx *gorm.DB, ids []models.Asset)) *AssetRepository_DeleteBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].([]models.Asset))
	})
	return _c
...
func (_c *AssetRepository_DeleteBatch_Call) Return(_a0 error) *AssetRepository_DeleteBatch_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AssetRepository_DeleteBatch_Call) RunAndReturn(run func(*gorm.DB, []models.Asset) error) *AssetRepository_DeleteBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetAssetIDByBadgeSecret provides a mock function with given fields: badgeSecret
func (_m *AssetRepository) GetAssetIDByBadgeSecret(badgeSecret uuid.UUID) (models.Asset, error) {
	ret := _m.Called(badgeSecret)
...
func (_c *AssetRepository_GetAssetIDByBadgeSecret_Call) Return(_a0 models.Asset, _a1 error) *AssetRepository_GetAssetIDByBadgeSecret_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AssetRepository_GetAssetIDByBadgeSecret_Call) RunAndReturn(run func(uuid.UUID) (models.Asset, error)) *AssetRepository_GetAssetIDByBadgeSecret_Call {
	_c.Call.Return(run)
	return _c
}
...
// ReadWithAssetVersions provides a mock function with given fields: assetID
func (_m *AssetRepository) ReadWithAssetVersions(assetID uuid.UUID) (models.Asset, error) {
...
func (_c *AssetRepository_ReadWithAssetVersions_Call) Return(_a0 models.Asset, _a1 error) *AssetRepository_ReadWithAssetVersions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AssetRepository_ReadWithAssetVersions_Call) RunAndReturn(run func(uuid.UUID) (models.Asset, error)) *AssetRepository_ReadWithAssetVersions_Call {
	_c.Call.Return(run)
	return _c
}
