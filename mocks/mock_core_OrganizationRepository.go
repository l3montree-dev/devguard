...
func (_m *CoreOrganizationRepository) GetOrgByID(id uuid.UUID) (models.Org, error) {
	ret := _m.Called(id)
...
// CoreOrganizationRepository_GetOrgByID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetOrgByID'
type CoreOrganizationRepository_GetOrgByID_Call struct {
	*mock.Call
}

// GetOrgByID is a helper method to define mock.On call
//   - id uuid.UUID
func (_e *CoreOrganizationRepository_Expecter) GetOrgByID(id interface{}) *CoreOrganizationRepository_GetOrgByID_Call {
	return &CoreOrganizationRepository_GetOrgByID_Call{Call: _e.mock.On("GetOrgByID", id)}
}

func (_c *CoreOrganizationRepository_GetOrgByID_Call) Run(run func(id uuid.UUID)) *CoreOrganizationRepository_GetOrgByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CoreOrganizationRepository_GetOrgByID_Call) Return(_a0 models.Org, _a1 error) *CoreOrganizationRepository_GetOrgByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CoreOrganizationRepository_GetOrgByID_Call) RunAndReturn(run func(uuid.UUID) (models.Org, error)) *CoreOrganizationRepository_GetOrgByID_Call {
	_c.Call.Return(run)
	return _c
}
