...
func (_m *CoreDependencyVulnRepository) GetDependencyVulnsByAssetVersion(tx *gorm.DB, assetVersionName string, assetID uuid.UUID) ([]models.DependencyVuln, error) {
	ret := _m.Called(tx, assetVersionName, assetID)
...
//   - assetVersionName string
//   - assetID uuid.UUID
func (_e *CoreDependencyVulnRepository_Expecter) GetDependencyVulnsByAssetVersion(tx interface{}, assetVersionName interface{}, assetID interface{}) *CoreDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	return &CoreDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call{Call: _e.mock.On("GetDependencyVulnsByAssetVersion", tx, assetVersionName, assetID)}
}

func (_c *CoreDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID)) *CoreDependencyVulnRepository_GetDependencyVulnsByAssetVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].(string), args[2].(uuid.UUID))
	})
	return _c
...
func (_m *CoreDependencyVulnRepository) ListByAssetAndAssetVersion(assetVersionName string, assetID uuid.UUID) ([]models.DependencyVuln, error) {
...
// CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListByAssetAndAssetVersion'
type CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call struct {
	*mock.Call
}
...
//   - assetVersionName string
//   - assetID uuid.UUID
func (_e *CoreDependencyVulnRepository_Expecter) ListByAssetAndAssetVersion(assetVersionName interface{}, assetID interface{}) *CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call {
	return &CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call{Call: _e.mock.On("ListByAssetAndAssetVersion", assetVersionName, assetID)}
}

func (_c *CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call) Run(run func(assetVersionName string, assetID uuid.UUID)) *CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call) Return(_a0 []models.DependencyVuln, _a1 error) *CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call) RunAndReturn(run func(string, uuid.UUID) ([]models.DependencyVuln, error)) *CoreDependencyVulnRepository_ListByAssetAndAssetVersion_Call {
	_c.Call.Return(run)
	return _c
}
