...
func (_c *AssetRepository_Begin_Call) Return(_a0 core.DB) *AssetRepository_Begin_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *AssetRepository_Create_Call) RunAndReturn(run func(core.DB, *models.Asset) error) *AssetRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *AssetRepository_CreateBatch_Call) RunAndReturn(run func(core.DB, []models.Asset) error) *AssetRepository_CreateBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *AssetRepository_Delete_Call) RunAndReturn(run func(core.DB, uuid.UUID) error) *AssetRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AssetRepository) FindOrCreate(tx core.DB, name string) (models.Asset, error) {
	...
	var r0 models.Asset
	var r1 error
	if rf, ok := ret.Get(0).(func(core.DB, string) (models.Asset, error)); ok {
		return rf(tx, name)
	}
	if rf, ok := ret.Get(0).(func(core.DB, string) models.Asset); ok {
		r0 = rf(tx, name)
	} else {
		r0 = ret.Get(0).(models.Asset)
	}
...
func (_c *AssetRepository_FindOrCreate_Call) RunAndReturn(run func(core.DB, string) (models.Asset, error)) *AssetRepository_FindOrCreate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *AssetRepository_GetDB_Call) Return(_a0 core.DB) *AssetRepository_GetDB_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *AssetRepository_Save_Call) RunAndReturn(run func(core.DB, *models.Asset) error) *AssetRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *AssetRepository_SaveBatch_Call) RunAndReturn(run func(core.DB, []models.Asset) error) *AssetRepository_SaveBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *AssetRepository_Transaction_Call) Run(run func(_a0 func(core.DB) error)) *AssetRepository_Transaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AssetRepository_Transaction_Call) RunAndReturn(run func(func(core.DB) error) error) *AssetRepository_Transaction_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *AssetRepository_Update_Call) Run(run func(tx core.DB, _a1 *models.Asset)) *AssetRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(*models.Asset))
	})
	return _c
...
func (_c *AssetRepository_Update_Call) RunAndReturn(run func(core.DB, *models.Asset) error) *AssetRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
