...
// GetRepositoryCollaborators provides a mock function for the type GithubClientFacade
func (_mock *GithubClientFacade) GetRepositoryCollaborators(ctx context.Context, owner string, repoId string, opts *github.ListCollaboratorsOptions) ([]*github.User, *github.Response, error) {
	ret := _mock.Called(ctx, owner, repoId, opts)

	if len(ret) == 0 {
		panic("no return value specified for GetRepositoryCollaborators")
	}

	var r0 []*github.User
	var r1 *github.Response
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, *github.ListCollaboratorsOptions) ([]*github.User, *github.Response, error)); ok {
		return returnFunc(ctx, owner, repoId, opts)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, *github.ListCollaboratorsOptions) []*github.User); ok {
		r0 = returnFunc(ctx, owner, repoId, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*github.User)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, *github.ListCollaboratorsOptions) *github.Response); ok {
		r1 = returnFunc(ctx, owner, repoId, opts)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*github.Response)
		}
	}
	if returnFunc, ok := ret.Get(2).(func(context.Context, string, string, *github.ListCollaboratorsOptions) error); ok {
		r2 = returnFunc(ctx, owner, repoId, opts)
	} else {
		r2 = ret.Error(2)
	}
	return r0, r1, r2
...
// GithubClientFacade_GetRepositoryCollaborators_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetRepositoryCollaborators'
type GithubClientFacade_GetRepositoryCollaborators_Call struct {
	*mock.Call
}

// GetRepositoryCollaborators is a helper method to define mock.On call
//   - ctx
//   - owner
//   - repoId
//   - opts
func (_e *GithubClientFacade_Expecter) GetRepositoryCollaborators(ctx interface{}, owner interface{}, repoId interface{}, opts interface{}) *GithubClientFacade_GetRepositoryCollaborators_Call {
	return &GithubClientFacade_GetRepositoryCollaborators_Call{Call: _e.mock.On("GetRepositoryCollaborators", ctx, owner, repoId, opts)}
}

func (_c *GithubClientFacade_GetRepositoryCollaborators_Call) Run(run func(ctx context.Context, owner string, repoId string, opts *github.ListCollaboratorsOptions)) *GithubClientFacade_GetRepositoryCollaborators_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(*github.ListCollaboratorsOptions))
	})
	return _c
}

func (_c *GithubClientFacade_GetRepositoryCollaborators_Call) Return(users []*github.User, response *github.Response, err error) *GithubClientFacade_GetRepositoryCollaborators_Call {
	_c.Call.Return(users, response, err)
	return _c
}

func (_c *GithubClientFacade_GetRepositoryCollaborators_Call) RunAndReturn(run func(ctx context.Context, owner string, repoId string, opts *github.ListCollaboratorsOptions) ([]*github.User, *github.Response, error)) *GithubClientFacade_GetRepositoryCollaborators_Call {
	_c.Call.Return(run)
	return _c
}
