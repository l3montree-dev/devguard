...
func (_m *VulndbRepository) FindAllListPaged(tx database.DB, pageInfo core.PageInfo, filter []core.FilterQuery, sort []core.SortQuery) (core.Paged[models.CVE], error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(database.DB, core.PageInfo, []core.FilterQuery, []core.SortQuery) (core.Paged[models.CVE], error)); ok {
		return rf(tx, pageInfo, filter, sort)
	}
	if rf, ok := ret.Get(0).(func(database.DB, core.PageInfo, []core.FilterQuery, []core.SortQuery) core.Paged[models.CVE]); ok {
		r0 = rf(tx, pageInfo, filter, sort)
	} else {
		r0 = ret.Get(0).(core.Paged[models.CVE])
	}

	if rf, ok := ret.Get(1).(func(database.DB, core.PageInfo, []core.FilterQuery, []core.SortQuery) error); ok {
...
func (_c *VulndbRepository_FindAllListPaged_Call) Run(run func(tx database.DB, pageInfo core.PageInfo, filter []core.FilterQuery, sort []core.SortQuery)) *VulndbRepository_FindAllListPaged_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(database.DB), args[1].(core.PageInfo), args[2].([]core.FilterQuery), args[3].([]core.SortQuery))
	})
	return _c
}
...
func (_c *VulndbRepository_FindAllListPaged_Call) RunAndReturn(run func(database.DB, core.PageInfo, []core.FilterQuery, []core.SortQuery) (core.Paged[models.CVE], error)) *VulndbRepository_FindAllListPaged_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *VulndbRepository) FindCVE(tx database.DB, cveId string) (models.CVE, error) {
	...
	var r0 models.CVE
	var r1 error
	if rf, ok := ret.Get(0).(func(database.DB, string) (models.CVE, error)); ok {
		return rf(tx, cveId)
	}
	if rf, ok := ret.Get(0).(func(database.DB, string) models.CVE); ok {
		r0 = rf(tx, cveId)
	} else {
		r0 = ret.Get(0).(models.CVE)
	}

	if rf, ok := ret.Get(1).(func(database.DB, string) error); ok {
		r1 = rf(tx, cveId)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *VulndbRepository_FindCVE_Call) Run(run func(tx database.DB, cveId string)) *VulndbRepository_FindCVE_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *VulndbRepository_FindCVE_Call) RunAndReturn(run func(database.DB, string) (models.CVE, error)) *VulndbRepository_FindCVE_Call {
	_c.Call.Return(run)
	return _c
}
