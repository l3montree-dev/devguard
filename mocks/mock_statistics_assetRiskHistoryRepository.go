...
func (_m *StatisticsAssetRiskHistoryRepository) GetRiskHistory(assetVersionName string, assetID uuid.UUID, start time.Time, end time.Time) ([]models.AssetRiskHistory, error) {
...
//   - start time.Time
//   - end time.Time
func (_e *StatisticsAssetRiskHistoryRepository_Expecter) GetRiskHistory(assetVersionName interface{}, assetID interface{}, start interface{}, end interface{}) *StatisticsAssetRiskHistoryRepository_GetRiskHistory_Call {
	return &StatisticsAssetRiskHistoryRepository_GetRiskHistory_Call{Call: _e.mock.On("GetRiskHistory", assetVersionName, assetID, start, end)}
}

func (_c *StatisticsAssetRiskHistoryRepository_GetRiskHistory_Call) Run(run func(assetVersionName string, assetID uuid.UUID, start time.Time, end time.Time)) *StatisticsAssetRiskHistoryRepository_GetRiskHistory_Call {
...
func (_c *StatisticsAssetRiskHistoryRepository_GetRiskHistory_Call) RunAndReturn(run func(string, uuid.UUID, time.Time, time.Time) ([]models.AssetRiskHistory, error)) *StatisticsAssetRiskHistoryRepository_GetRiskHistory_Call {
	_c.Call.Return(run)
	return _c
}
