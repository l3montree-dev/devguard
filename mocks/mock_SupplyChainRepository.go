...
// CleanupOrphanedRecords provides a mock function for the type SupplyChainRepository
func (_mock *SupplyChainRepository) CleanupOrphanedRecords(ctx context.Context) error {
	ret := _mock.Called(ctx)
...
// SupplyChainRepository_CleanupOrphanedRecords_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CleanupOrphanedRecords'
type SupplyChainRepository_CleanupOrphanedRecords_Call struct {
	*mock.Call
}
...
func (_c *SupplyChainRepository_CleanupOrphanedRecords_Call) Run(run func(ctx context.Context)) *SupplyChainRepository_CleanupOrphanedRecords_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *SupplyChainRepository_CleanupOrphanedRecords_Call) Return(err error) *SupplyChainRepository_CleanupOrphanedRecords_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *SupplyChainRepository_CleanupOrphanedRecords_Call) RunAndReturn(run func(ctx context.Context) error) *SupplyChainRepository_CleanupOrphanedRecords_Call {
	_c.Call.Return(run)
	return _c
}
...
// InBatches provides a mock function for the type SupplyChainRepository
func (_mock *SupplyChainRepository) InBatches(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.SupplyChain, error] {
	...
	var r0 iter.Seq2[[]models.SupplyChain, error]
	if returnFunc, ok := ret.Get(0).(func(context.Context, shared.DB, int) iter.Seq2[[]models.SupplyChain, error]); ok {
		r0 = returnFunc(ctx, tx, batchSize)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(iter.Seq2[[]models.SupplyChain, error])
		}
	}
	return r0
}

// SupplyChainRepository_InBatches_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InBatches'
type SupplyChainRepository_InBatches_Call struct {
	*mock.Call
}
...
func (_c *SupplyChainRepository_InBatches_Call) Run(run func(ctx context.Context, tx shared.DB, batchSize int)) *SupplyChainRepository_InBatches_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *SupplyChainRepository_InBatches_Call) Return(seq2 iter.Seq2[[]models.SupplyChain, error]) *SupplyChainRepository_InBatches_Call {
	_c.Call.Return(seq2)
	return _c
}

func (_c *SupplyChainRepository_InBatches_Call) RunAndReturn(run func(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.SupplyChain, error]) *SupplyChainRepository_InBatches_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - tx shared.DB
//   - ts []models.SupplyChain
func (_e *SupplyChainRepository_Expecter) SaveBatchBestEffort(ctx any, tx any, ts any) *SupplyChainRepository_SaveBatchBestEffort_Call {
