...
// UpdateDependencyVulnState provides a mock function with given fields: tx, assetID, userID, dependencyVuln, statusType, justification, mechanicalJustification, assetVersionName
func (_m *DependencyVulnService) UpdateDependencyVulnState(tx *gorm.DB, assetID uuid.UUID, userID string, dependencyVuln *models.DependencyVuln, statusType string, justification string, mechanicalJustification models.MechanicalJustificationType, assetVersionName string) (models.VulnEvent, error) {
	ret := _m.Called(tx, assetID, userID, dependencyVuln, statusType, justification, mechanicalJustification, assetVersionName)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*gorm.DB, uuid.UUID, string, *models.DependencyVuln, string, string, models.MechanicalJustificationType, string) (models.VulnEvent, error)); ok {
		return rf(tx, assetID, userID, dependencyVuln, statusType, justification, mechanicalJustification, assetVersionName)
	}
	if rf, ok := ret.Get(0).(func(*gorm.DB, uuid.UUID, string, *models.DependencyVuln, string, string, models.MechanicalJustificationType, string) models.VulnEvent); ok {
		r0 = rf(tx, assetID, userID, dependencyVuln, statusType, justification, mechanicalJustification, assetVersionName)
	} else {
		r0 = ret.Get(0).(models.VulnEvent)
	}

	if rf, ok := ret.Get(1).(func(*gorm.DB, uuid.UUID, string, *models.DependencyVuln, string, string, models.MechanicalJustificationType, string) error); ok {
		r1 = rf(tx, assetID, userID, dependencyVuln, statusType, justification, mechanicalJustification, assetVersionName)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *DependencyVulnService_UpdateDependencyVulnState_Call) Run(run func(tx *gorm.DB, assetID uuid.UUID, userID string, dependencyVuln *models.DependencyVuln, statusType string, justification string, mechanicalJustification models.MechanicalJustificationType, assetVersionName string)) *DependencyVulnService_UpdateDependencyVulnState_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].(uuid.UUID), args[2].(string), args[3].(*models.DependencyVuln), args[4].(string), args[5].(string), args[6].(models.MechanicalJustificationType), args[7].(string))
	})
	return _c
}
...
func (_c *DependencyVulnService_UpdateDependencyVulnState_Call) RunAndReturn(run func(*gorm.DB, uuid.UUID, string, *models.DependencyVuln, string, string, models.MechanicalJustificationType, string) (models.VulnEvent, error)) *DependencyVulnService_UpdateDependencyVulnState_Call {
	_c.Call.Return(run)
	return _c
}
