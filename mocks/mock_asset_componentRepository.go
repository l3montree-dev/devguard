...
func (_m *AssetComponentRepository) FindByPurl(tx core.DB, purl string) (models.Component, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(core.DB, string) (models.Component, error)); ok {
		return rf(tx, purl)
	}
	if rf, ok := ret.Get(0).(func(core.DB, string) models.Component); ok {
		r0 = rf(tx, purl)
	} else {
...
func (_c *AssetComponentRepository_FindByPurl_Call) Run(run func(tx core.DB, purl string)) *AssetComponentRepository_FindByPurl_Call {
...
func (_c *AssetComponentRepository_FindByPurl_Call) RunAndReturn(run func(core.DB, string) (models.Component, error)) *AssetComponentRepository_FindByPurl_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AssetComponentRepository) HandleStateDiff(tx database.DB, assetID uuid.UUID, version string, oldState []models.ComponentDependency, newState []models.ComponentDependency) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(database.DB, uuid.UUID, string, []models.ComponentDependency, []models.ComponentDependency) error); ok {
...
func (_c *AssetComponentRepository_HandleStateDiff_Call) Run(run func(tx database.DB, assetID uuid.UUID, version string, oldState []models.ComponentDependency, newState []models.ComponentDependency)) *AssetComponentRepository_HandleStateDiff_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(database.DB), args[1].(uuid.UUID), args[2].(string), args[3].([]models.ComponentDependency), args[4].([]models.ComponentDependency))
	})
	return _c
}
...
func (_c *AssetComponentRepository_HandleStateDiff_Call) RunAndReturn(run func(database.DB, uuid.UUID, string, []models.ComponentDependency, []models.ComponentDependency) error) *AssetComponentRepository_HandleStateDiff_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *AssetComponentRepository_Expecter) LoadComponents(tx interface{}, _a1 interface{}, scanType interface{}, version interface{}) *AssetComponentRepository_LoadComponents_Call {
	return &AssetComponentRepository_LoadComponents_Call{Call: _e.mock.On("LoadComponents", tx, _a1, scanType, version)}
}

func (_c *AssetComponentRepository_LoadComponents_Call) Run(run func(tx core.DB, _a1 models.Asset, scanType string, version string)) *AssetComponentRepository_LoadComponents_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AssetComponentRepository_LoadComponents_Call) RunAndReturn(run func(core.DB, models.Asset, string, string) ([]models.ComponentDependency, error)) *AssetComponentRepository_LoadComponents_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AssetComponentRepository) SaveBatch(tx core.DB, components []models.Component) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, []models.Component) error); ok {
		r0 = rf(tx, components)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *AssetComponentRepository_SaveBatch_Call) Run(run func(tx core.DB, components []models.Component)) *AssetComponentRepository_SaveBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AssetComponentRepository_SaveBatch_Call) RunAndReturn(run func(core.DB, []models.Component) error) *AssetComponentRepository_SaveBatch_Call {
	_c.Call.Return(run)
	return _c
}
