...
func (_c *FlawRepository_Begin_Call) Return(_a0 core.DB) *FlawRepository_Begin_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *FlawRepository_Create_Call) Run(run func(tx core.DB, t *models.Flaw)) *FlawRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FlawRepository_Create_Call) RunAndReturn(run func(core.DB, *models.Flaw) error) *FlawRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawRepository_CreateBatch_Call) Run(run func(tx core.DB, ts []models.Flaw)) *FlawRepository_CreateBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].([]models.Flaw))
	})
	return _c
...
func (_c *FlawRepository_CreateBatch_Call) RunAndReturn(run func(core.DB, []models.Flaw) error) *FlawRepository_CreateBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *FlawRepository) Delete(tx core.DB, id string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, string) error); ok {
		r0 = rf(tx, id)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *FlawRepository_Delete_Call) Run(run func(tx core.DB, id string)) *FlawRepository_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FlawRepository_Delete_Call) RunAndReturn(run func(core.DB, string) error) *FlawRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawRepository_GetByAssetId_Call) Run(run func(tx core.DB, assetId uuid.UUID)) *FlawRepository_GetByAssetId_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FlawRepository_GetByAssetId_Call) RunAndReturn(run func(core.DB, uuid.UUID) ([]models.Flaw, error)) *FlawRepository_GetByAssetId_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *FlawRepository) GetByAssetIdPaged(tx core.DB, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery, assetId uuid.UUID) (core.Paged[models.Flaw], map[string]int, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(core.DB, core.PageInfo, string, []core.FilterQuery, []core.SortQuery, uuid.UUID) (core.Paged[models.Flaw], map[string]int, error)); ok {
		return rf(tx, pageInfo, search, filter, sort, assetId)
	}
	if rf, ok := ret.Get(0).(func(core.DB, core.PageInfo, string, []core.FilterQuery, []core.SortQuery, uuid.UUID) core.Paged[models.Flaw]); ok {
		r0 = rf(tx, pageInfo, search, filter, sort, assetId)
	} else {
		r0 = ret.Get(0).(core.Paged[models.Flaw])
	}

	if rf, ok := ret.Get(1).(func(core.DB, core.PageInfo, string, []core.FilterQuery, []core.SortQuery, uuid.UUID) map[string]int); ok {
	...
	if rf, ok := ret.Get(2).(func(core.DB, core.PageInfo, string, []core.FilterQuery, []core.SortQuery, uuid.UUID) error); ok {
...
func (_c *FlawRepository_GetByAssetIdPaged_Call) Run(run func(tx core.DB, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery, assetId uuid.UUID)) *FlawRepository_GetByAssetIdPaged_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(core.PageInfo), args[2].(string), args[3].([]core.FilterQuery), args[4].([]core.SortQuery), args[5].(uuid.UUID))
	})
	return _c
}
...
func (_c *FlawRepository_GetByAssetIdPaged_Call) RunAndReturn(run func(core.DB, core.PageInfo, string, []core.FilterQuery, []core.SortQuery, uuid.UUID) (core.Paged[models.Flaw], map[string]int, error)) *FlawRepository_GetByAssetIdPaged_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawRepository_GetDB_Call) Run(run func(tx core.DB)) *FlawRepository_GetDB_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB))
	})
	return _c
...
func (_c *FlawRepository_GetDB_Call) Return(_a0 core.DB) *FlawRepository_GetDB_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *FlawRepository) GetFlawsByAssetIdPagedAndFlat(tx core.DB, assetId uuid.UUID, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery) (core.Paged[models.Flaw], error) {
	...
	var r0 core.Paged[models.Flaw]
	var r1 error
	if rf, ok := ret.Get(0).(func(core.DB, uuid.UUID, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) (core.Paged[models.Flaw], error)); ok {
		return rf(tx, assetId, pageInfo, search, filter, sort)
	}
	if rf, ok := ret.Get(0).(func(core.DB, uuid.UUID, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) core.Paged[models.Flaw]); ok {
		r0 = rf(tx, assetId, pageInfo, search, filter, sort)
	} else {
		r0 = ret.Get(0).(core.Paged[models.Flaw])
	}

	if rf, ok := ret.Get(1).(func(core.DB, uuid.UUID, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) error); ok {
...
func (_c *FlawRepository_GetFlawsByAssetIdPagedAndFlat_Call) Run(run func(tx core.DB, assetId uuid.UUID, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery)) *FlawRepository_GetFlawsByAssetIdPagedAndFlat_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FlawRepository_GetFlawsByAssetIdPagedAndFlat_Call) RunAndReturn(run func(core.DB, uuid.UUID, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) (core.Paged[models.Flaw], error)) *FlawRepository_GetFlawsByAssetIdPagedAndFlat_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *FlawRepository) GetFlawsByOrgIdPaged(tx core.DB, userAllowedProjectIds []string, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery) (core.Paged[models.Flaw], error) {
	...
	var r0 core.Paged[models.Flaw]
	var r1 error
	if rf, ok := ret.Get(0).(func(core.DB, []string, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) (core.Paged[models.Flaw], error)); ok {
		return rf(tx, userAllowedProjectIds, pageInfo, search, filter, sort)
	}
	if rf, ok := ret.Get(0).(func(core.DB, []string, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) core.Paged[models.Flaw]); ok {
		r0 = rf(tx, userAllowedProjectIds, pageInfo, search, filter, sort)
	} else {
		r0 = ret.Get(0).(core.Paged[models.Flaw])
	}

	if rf, ok := ret.Get(1).(func(core.DB, []string, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) error); ok {
...
func (_c *FlawRepository_GetFlawsByOrgIdPaged_Call) RunAndReturn(run func(core.DB, []string, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) (core.Paged[models.Flaw], error)) *FlawRepository_GetFlawsByOrgIdPaged_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawRepository_GetFlawsByProjectIdPaged_Call) Run(run func(tx core.DB, projectID uuid.UUID, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery)) *FlawRepository_GetFlawsByProjectIdPaged_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(uuid.UUID), args[2].(core.PageInfo), args[3].(string), args[4].([]core.FilterQuery), args[5].([]core.SortQuery))
	})
	return _c
...
func (_c *FlawRepository_GetFlawsByProjectIdPaged_Call) RunAndReturn(run func(core.DB, uuid.UUID, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) (core.Paged[models.Flaw], error)) *FlawRepository_GetFlawsByProjectIdPaged_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawRepository_Save_Call) Run(run func(tx core.DB, t *models.Flaw)) *FlawRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].(*models.Flaw))
	})
	return _c
...
func (_c *FlawRepository_SaveBatch_Call) Run(run func(tx core.DB, ts []models.Flaw)) *FlawRepository_SaveBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].([]models.Flaw))
	})
	return _c
...
func (_c *FlawRepository_SaveBatch_Call) RunAndReturn(run func(core.DB, []models.Flaw) error) *FlawRepository_SaveBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlawRepository_Transaction_Call) Run(run func(_a0 func(core.DB) error)) *FlawRepository_Transaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FlawRepository_Transaction_Call) RunAndReturn(run func(func(core.DB) error) error) *FlawRepository_Transaction_Call {
	_c.Call.Return(run)
	return _c
}
