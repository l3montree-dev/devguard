...
func (_m *DependencyVulnRepository) Create(tx *gorm.DB, t *models.DependencyVulnerability) error {
	ret := _m.Called(tx, t)
...
func (_c *DependencyVulnRepository_Create_Call) Run(run func(tx *gorm.DB, t *models.DependencyVulnerability)) *DependencyVulnRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DependencyVulnRepository_Create_Call) RunAndReturn(run func(*gorm.DB, *models.DependencyVulnerability) error) *DependencyVulnRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}

// CreateBatch provides a mock function with given fields: tx, ts
func (_m *DependencyVulnRepository) CreateBatch(tx *gorm.DB, ts []models.DependencyVulnerability) error {
	ret := _m.Called(tx, ts)
...
func (_c *DependencyVulnRepository_CreateBatch_Call) Run(run func(tx *gorm.DB, ts []models.DependencyVulnerability)) *DependencyVulnRepository_CreateBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].([]models.DependencyVulnerability))
	})
	return _c
...
func (_c *DependencyVulnRepository_CreateBatch_Call) RunAndReturn(run func(*gorm.DB, []models.DependencyVulnerability) error) *DependencyVulnRepository_CreateBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *DependencyVulnRepository) GetByAssetId(tx *gorm.DB, assetId uuid.UUID) ([]models.DependencyVulnerability, error) {
...
func (_c *DependencyVulnRepository_GetByAssetId_Call) Return(_a0 []models.DependencyVulnerability, _a1 error) *DependencyVulnRepository_GetByAssetId_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DependencyVulnRepository_GetByAssetId_Call) RunAndReturn(run func(*gorm.DB, uuid.UUID) ([]models.DependencyVulnerability, error)) *DependencyVulnRepository_GetByAssetId_Call {
	_c.Call.Return(run)
	return _c
}

// GetByAssetIdPaged provides a mock function with given fields: tx, pageInfo, search, filter, sort, assetId
func (_m *DependencyVulnRepository) GetByAssetIdPaged(tx *gorm.DB, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery, assetId uuid.UUID) (core.Paged[models.DependencyVulnerability], map[string]int, error) {
...
func (_c *DependencyVulnRepository_GetByAssetIdPaged_Call) Return(_a0 core.Paged[models.DependencyVulnerability], _a1 map[string]int, _a2 error) *DependencyVulnRepository_GetByAssetIdPaged_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *DependencyVulnRepository_GetByAssetIdPaged_Call) RunAndReturn(run func(*gorm.DB, core.PageInfo, string, []core.FilterQuery, []core.SortQuery, uuid.UUID) (core.Paged[models.DependencyVulnerability], map[string]int, error)) *DependencyVulnRepository_GetByAssetIdPaged_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *DependencyVulnRepository) GetDependencyVulnsByAssetIdPagedAndFlat(tx *gorm.DB, assetId uuid.UUID, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery) (core.Paged[models.DependencyVulnerability], error) {
...
func (_c *DependencyVulnRepository_GetDependencyVulnsByAssetIdPagedAndFlat_Call) Return(_a0 core.Paged[models.DependencyVulnerability], _a1 error) *DependencyVulnRepository_GetDependencyVulnsByAssetIdPagedAndFlat_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DependencyVulnRepository_GetDependencyVulnsByAssetIdPagedAndFlat_Call) RunAndReturn(run func(*gorm.DB, uuid.UUID, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) (core.Paged[models.DependencyVulnerability], error)) *DependencyVulnRepository_GetDependencyVulnsByAssetIdPagedAndFlat_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *DependencyVulnRepository) GetDependencyVulnsByOrgIdPaged(tx *gorm.DB, userAllowedProjectIds []string, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery) (core.Paged[models.DependencyVulnerability], error) {
...
func (_c *DependencyVulnRepository_GetDependencyVulnsByOrgIdPaged_Call) Return(_a0 core.Paged[models.DependencyVulnerability], _a1 error) *DependencyVulnRepository_GetDependencyVulnsByOrgIdPaged_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DependencyVulnRepository_GetDependencyVulnsByOrgIdPaged_Call) RunAndReturn(run func(*gorm.DB, []string, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) (core.Paged[models.DependencyVulnerability], error)) *DependencyVulnRepository_GetDependencyVulnsByOrgIdPaged_Call {
	_c.Call.Return(run)
	return _c
}

// GetDependencyVulnsByProjectIdPaged provides a mock function with given fields: tx, projectID, pageInfo, search, filter, sort
func (_m *DependencyVulnRepository) GetDependencyVulnsByProjectIdPaged(tx *gorm.DB, projectID uuid.UUID, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery) (core.Paged[models.DependencyVulnerability], error) {
...
func (_c *DependencyVulnRepository_GetDependencyVulnsByProjectIdPaged_Call) Return(_a0 core.Paged[models.DependencyVulnerability], _a1 error) *DependencyVulnRepository_GetDependencyVulnsByProjectIdPaged_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DependencyVulnRepository_GetDependencyVulnsByProjectIdPaged_Call) RunAndReturn(run func(*gorm.DB, uuid.UUID, core.PageInfo, string, []core.FilterQuery, []core.SortQuery) (core.Paged[models.DependencyVulnerability], error)) *DependencyVulnRepository_GetDependencyVulnsByProjectIdPaged_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function with given fields: ids
func (_m *DependencyVulnRepository) List(ids []string) ([]models.DependencyVulnerability, error) {
	ret := _m.Called(ids)
...
func (_c *DependencyVulnRepository_List_Call) Return(_a0 []models.DependencyVulnerability, _a1 error) *DependencyVulnRepository_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DependencyVulnRepository_List_Call) RunAndReturn(run func([]string) ([]models.DependencyVulnerability, error)) *DependencyVulnRepository_List_Call {
	_c.Call.Return(run)
	return _c
}

// Read provides a mock function with given fields: id
func (_m *DependencyVulnRepository) Read(id string) (models.DependencyVulnerability, error) {
	ret := _m.Called(id)
...
func (_c *DependencyVulnRepository_Read_Call) Return(_a0 models.DependencyVulnerability, _a1 error) *DependencyVulnRepository_Read_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DependencyVulnRepository_Read_Call) RunAndReturn(run func(string) (models.DependencyVulnerability, error)) *DependencyVulnRepository_Read_Call {
	_c.Call.Return(run)
	return _c
}

// Save provides a mock function with given fields: tx, t
func (_m *DependencyVulnRepository) Save(tx *gorm.DB, t *models.DependencyVulnerability) error {
	ret := _m.Called(tx, t)
...
func (_c *DependencyVulnRepository_Save_Call) Run(run func(tx *gorm.DB, t *models.DependencyVulnerability)) *DependencyVulnRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].(*models.DependencyVulnerability))
	})
	return _c
...
func (_c *DependencyVulnRepository_Save_Call) RunAndReturn(run func(*gorm.DB, *models.DependencyVulnerability) error) *DependencyVulnRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}

// SaveBatch provides a mock function with given fields: tx, ts
func (_m *DependencyVulnRepository) SaveBatch(tx *gorm.DB, ts []models.DependencyVulnerability) error {
	ret := _m.Called(tx, ts)
...
func (_c *DependencyVulnRepository_SaveBatch_Call) Run(run func(tx *gorm.DB, ts []models.DependencyVulnerability)) *DependencyVulnRepository_SaveBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].([]models.DependencyVulnerability))
	})
	return _c
...
func (_c *DependencyVulnRepository_SaveBatch_Call) RunAndReturn(run func(*gorm.DB, []models.DependencyVulnerability) error) *DependencyVulnRepository_SaveBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
// NewDependencyVulnerability creates a new instance of DependencyVulnRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
