...
// List provides a mock function with given fields: idSlice, parentID, tenantID
func (_m *CoreProjectRepository) List(idSlice []uuid.UUID, parentID *uuid.UUID, tenantID uuid.UUID) ([]models.Project, error) {
	ret := _m.Called(idSlice, parentID, tenantID)
	...
	if rf, ok := ret.Get(1).(func([]uuid.UUID, *uuid.UUID, uuid.UUID) error); ok {
		r1 = rf(idSlice, parentID, tenantID)
	} else {
		r1 = ret.Error(1)
	}
...
//   - parentID *uuid.UUID
//   - tenantID uuid.UUID
func (_e *CoreProjectRepository_Expecter) List(idSlice interface{}, parentID interface{}, tenantID interface{}) *CoreProjectRepository_List_Call {
	return &CoreProjectRepository_List_Call{Call: _e.mock.On("List", idSlice, parentID, tenantID)}
}

func (_c *CoreProjectRepository_List_Call) Run(run func(idSlice []uuid.UUID, parentID *uuid.UUID, tenantID uuid.UUID)) *CoreProjectRepository_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
