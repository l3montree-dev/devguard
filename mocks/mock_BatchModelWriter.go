...
func NewBatchModelWriter[T utils.Tabler, Tx any](t interface {
	mock.TestingT
	Cleanup(func())
...
type BatchModelWriter[T utils.Tabler, Tx any] struct {
	mock.Mock
}

type BatchModelWriter_Expecter[T utils.Tabler, Tx any] struct {
	mock *mock.Mock
}
...
type BatchModelWriter_CreateBatch_Call[T utils.Tabler, Tx any] struct {
	*mock.Call
}
...
type BatchModelWriter_DeleteBatch_Call[T utils.Tabler, Tx any] struct {
	*mock.Call
}
...
type BatchModelWriter_SaveBatch_Call[T utils.Tabler, Tx any] struct {
	*mock.Call
}
...
//   - tx Tx
//   - ts []T
func (_e *BatchModelWriter_Expecter[T, Tx]) SaveBatchBestEffort(ctx any, tx any, ts any) *BatchModelWriter_SaveBatchBestEffort_Call[T, Tx] {
