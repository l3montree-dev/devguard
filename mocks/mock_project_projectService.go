...
func (_c *ProjectProjectService_ListAllowedProjects_Call) Run(run func(c core.Context)) *ProjectProjectService_ListAllowedProjects_Call {
...
func (_c *ProjectProjectService_ListAllowedProjects_Call) RunAndReturn(run func(core.Context) ([]models.Project, error)) *ProjectProjectService_ListAllowedProjects_Call {
	_c.Call.Return(run)
	return _c
}
