...
func (_m *CoreComponentRepository) GetLicenseDistribution(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scannerID string) (map[string]int, error) {
...
//   - assetID uuid.UUID
//   - scannerID string
func (_e *CoreComponentRepository_Expecter) GetLicenseDistribution(tx interface{}, assetVersionName interface{}, assetID interface{}, scannerID interface{}) *CoreComponentRepository_GetLicenseDistribution_Call {
	return &CoreComponentRepository_GetLicenseDistribution_Call{Call: _e.mock.On("GetLicenseDistribution", tx, assetVersionName, assetID, scannerID)}
}

func (_c *CoreComponentRepository_GetLicenseDistribution_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scannerID string)) *CoreComponentRepository_GetLicenseDistribution_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *CoreComponentRepository) HandleStateDiff(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, oldState []models.ComponentDependency, newState []models.ComponentDependency, scannerID string) error {
...
//   - scannerID string
func (_e *CoreComponentRepository_Expecter) HandleStateDiff(tx interface{}, assetVersionName interface{}, assetID interface{}, oldState interface{}, newState interface{}, scannerID interface{}) *CoreComponentRepository_HandleStateDiff_Call {
	return &CoreComponentRepository_HandleStateDiff_Call{Call: _e.mock.On("HandleStateDiff", tx, assetVersionName, assetID, oldState, newState, scannerID)}
}

func (_c *CoreComponentRepository_HandleStateDiff_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, oldState []models.ComponentDependency, newState []models.ComponentDependency, scannerID string)) *CoreComponentRepository_HandleStateDiff_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CoreComponentRepository_HandleStateDiff_Call) RunAndReturn(run func(*gorm.DB, string, uuid.UUID, []models.ComponentDependency, []models.ComponentDependency, string) error) *CoreComponentRepository_HandleStateDiff_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CoreComponentRepository) LoadComponents(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scannerID string) ([]models.ComponentDependency, error) {
	ret := _m.Called(tx, assetVersionName, assetID, scannerID)
...
//   - assetID uuid.UUID
//   - scannerID string
func (_e *CoreComponentRepository_Expecter) LoadComponents(tx interface{}, assetVersionName interface{}, assetID interface{}, scannerID interface{}) *CoreComponentRepository_LoadComponents_Call {
	return &CoreComponentRepository_LoadComponents_Call{Call: _e.mock.On("LoadComponents", tx, assetVersionName, assetID, scannerID)}
}

func (_c *CoreComponentRepository_LoadComponents_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scannerID string)) *CoreComponentRepository_LoadComponents_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gorm.DB), args[1].(string), args[2].(uuid.UUID), args[3].(string))
	})
	return _c
...
func (_m *CoreComponentRepository) LoadComponentsWithProject(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scannerID string, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery) (core.Paged[models.ComponentDependency], error) {
...
//   - sort []core.SortQuery
func (_e *CoreComponentRepository_Expecter) LoadComponentsWithProject(tx interface{}, assetVersionName interface{}, assetID interface{}, scannerID interface{}, pageInfo interface{}, search interface{}, filter interface{}, sort interface{}) *CoreComponentRepository_LoadComponentsWithProject_Call {
	return &CoreComponentRepository_LoadComponentsWithProject_Call{Call: _e.mock.On("LoadComponentsWithProject", tx, assetVersionName, assetID, scannerID, pageInfo, search, filter, sort)}
}

func (_c *CoreComponentRepository_LoadComponentsWithProject_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, scannerID string, pageInfo core.PageInfo, search string, filter []core.FilterQuery, sort []core.SortQuery)) *CoreComponentRepository_LoadComponentsWithProject_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *CoreComponentRepository) LoadPathToComponent(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, pURL string, scannerID string) ([]models.ComponentDependency, error) {
...
//   - pURL string
//   - scannerID string
func (_e *CoreComponentRepository_Expecter) LoadPathToComponent(tx interface{}, assetVersionName interface{}, assetID interface{}, pURL interface{}, scannerID interface{}) *CoreComponentRepository_LoadPathToComponent_Call {
	return &CoreComponentRepository_LoadPathToComponent_Call{Call: _e.mock.On("LoadPathToComponent", tx, assetVersionName, assetID, pURL, scannerID)}
}

func (_c *CoreComponentRepository_LoadPathToComponent_Call) Run(run func(tx *gorm.DB, assetVersionName string, assetID uuid.UUID, pURL string, scannerID string)) *CoreComponentRepository_LoadPathToComponent_Call {
	_c.Call.Run(func(args mock.Arguments) {
