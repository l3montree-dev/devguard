...
func (_c *PatRepository_Begin_Call) Return(_a0 core.DB) *PatRepository_Begin_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *PatRepository) Create(tx core.DB, t *models.PAT) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(core.DB, *models.PAT) error); ok {
		r0 = rf(tx, t)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *PatRepository_Create_Call) Run(run func(tx core.DB, t *models.PAT)) *PatRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PatRepository_Create_Call) RunAndReturn(run func(core.DB, *models.PAT) error) *PatRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PatRepository_CreateBatch_Call) Run(run func(tx core.DB, ts []models.PAT)) *PatRepository_CreateBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].([]models.PAT))
	})
	return _c
...
func (_c *PatRepository_CreateBatch_Call) RunAndReturn(run func(core.DB, []models.PAT) error) *PatRepository_CreateBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PatRepository_Delete_Call) Run(run func(tx core.DB, id uuid.UUID)) *PatRepository_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PatRepository_Delete_Call) RunAndReturn(run func(core.DB, uuid.UUID) error) *PatRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PatRepository_GetDB_Call) Run(run func(tx core.DB)) *PatRepository_GetDB_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB))
	})
	return _c
...
func (_c *PatRepository_GetDB_Call) Return(_a0 core.DB) *PatRepository_GetDB_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *PatRepository_SaveBatch_Call) Run(run func(tx core.DB, ts []models.PAT)) *PatRepository_SaveBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(core.DB), args[1].([]models.PAT))
	})
	return _c
...
func (_c *PatRepository_SaveBatch_Call) RunAndReturn(run func(core.DB, []models.PAT) error) *PatRepository_SaveBatch_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *PatRepository_Transaction_Call) Run(run func(_a0 func(core.DB) error)) *PatRepository_Transaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PatRepository_Transaction_Call) RunAndReturn(run func(func(core.DB) error) error) *PatRepository_Transaction_Call {
	_c.Call.Return(run)
	return _c
}
