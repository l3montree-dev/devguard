...
// FindOrCreate provides a mock function for the type ReleaseRepository
func (_mock *ReleaseRepository) FindOrCreate(ctx context.Context, tx shared.DB, projectID uuid.UUID, name string) (models.Release, error) {
	ret := _mock.Called(ctx, tx, projectID, name)
	...
	var r0 models.Release
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, shared.DB, uuid.UUID, string) (models.Release, error)); ok {
		return returnFunc(ctx, tx, projectID, name)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, shared.DB, uuid.UUID, string) models.Release); ok {
		r0 = returnFunc(ctx, tx, projectID, name)
	} else {
		r0 = ret.Get(0).(models.Release)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, shared.DB, uuid.UUID, string) error); ok {
		r1 = returnFunc(ctx, tx, projectID, name)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// ReleaseRepository_FindOrCreate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindOrCreate'
type ReleaseRepository_FindOrCreate_Call struct {
	*mock.Call
}
...
func (_c *ReleaseRepository_FindOrCreate_Call) Run(run func(ctx context.Context, tx shared.DB, projectID uuid.UUID, name string)) *ReleaseRepository_FindOrCreate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *ReleaseRepository_FindOrCreate_Call) Return(release models.Release, err error) *ReleaseRepository_FindOrCreate_Call {
	_c.Call.Return(release, err)
	return _c
}

func (_c *ReleaseRepository_FindOrCreate_Call) RunAndReturn(run func(ctx context.Context, tx shared.DB, projectID uuid.UUID, name string) (models.Release, error)) *ReleaseRepository_FindOrCreate_Call {
	_c.Call.Return(run)
	return _c
}
...
// InBatches provides a mock function for the type ReleaseRepository
func (_mock *ReleaseRepository) InBatches(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.Release, error] {
	...
	var r0 iter.Seq2[[]models.Release, error]
	if returnFunc, ok := ret.Get(0).(func(context.Context, shared.DB, int) iter.Seq2[[]models.Release, error]); ok {
		r0 = returnFunc(ctx, tx, batchSize)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(iter.Seq2[[]models.Release, error])
		}
	}
	return r0
}

// ReleaseRepository_InBatches_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InBatches'
type ReleaseRepository_InBatches_Call struct {
	*mock.Call
}
...
func (_c *ReleaseRepository_InBatches_Call) Run(run func(ctx context.Context, tx shared.DB, batchSize int)) *ReleaseRepository_InBatches_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *ReleaseRepository_InBatches_Call) Return(seq2 iter.Seq2[[]models.Release, error]) *ReleaseRepository_InBatches_Call {
	_c.Call.Return(seq2)
	return _c
}

func (_c *ReleaseRepository_InBatches_Call) RunAndReturn(run func(ctx context.Context, tx shared.DB, batchSize int) iter.Seq2[[]models.Release, error]) *ReleaseRepository_InBatches_Call {
	_c.Call.Return(run)
	return _c
}
