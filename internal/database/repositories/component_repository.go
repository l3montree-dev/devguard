...
func (c *componentRepository) SearchComponentOccurrencesByOrg(tx core.DB, orgID uuid.UUID, pageInfo core.PageInfo, search string) (core.Paged[models.ComponentOccurrence], error) {
