...
func TestGetComponentDepth(t *testing.T) {
	t.Run("returns correct depth map for simple dependency graph", func(t *testing.T) {
		...
		graph := []testNode{
			{Name: "root", Dep: "pkg:golang/a"},
			{Name: "pkg:golang/a", Dep: "pkg:golang/b"},
			{Name: "pkg:golang/a", Dep: "pkg:golang/c"},
			{Name: "pkg:golang/b", Dep: "pkg:golang/d"},
		}
		depthMap := GetComponentDepth[testNode](graph, "root")
	...
	t.Run("returns empty map for empty input", func(t *testing.T) {
		depthMap := GetComponentDepth([]testNode{}, "root")
	...
	t.Run("returns correct depth for single node", func(t *testing.T) {
		...
		depthMap := GetComponentDepth(graph, "root")
