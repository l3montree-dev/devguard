...
\fancyhead[C]{\sffamily\small{DevGuard SBOM Report for $app_title_part_one$ $app_title_part_two$ ($version$)}}
...
\begin{titlepage}
    ...
    \begin{picture}(-5,0)(2.5,0)
        ...
        \put(70,-140){\fontsize{40}{1}\selectfont\color{white}\textbf{DevGuard SBOM Report}}
