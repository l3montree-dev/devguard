...
\hypersetup{
    ...
    linktoc=all,
    pdftitle={$document_title$ - Version: $version$},
...
\fancyhead[C]{\sffamily\small{DevGuard Vulnerability Report for $app_title_part_one$ $app_title_part_two$ ($version$)}}
...
\begin{titlepage}
    ...
    \begin{picture}(-5,0)(2.5,0)
        ...
        \put(70,-140){\fontsize{40}{1}\selectfont\color{white}\textbf{DevGuard Vuln. Report}}
        \put(38,-620){\fontsize{11}{1}\selectfont\color{white}\textbf{$generation_date$}}
        \put(38,-680){\parbox{55mm}{\raggedright\fontsize{16}{1}\selectfont\color{white}\textbf{$app_title_part_one$}}}
        \put(38,-700){\parbox{55mm}{\raggedright\fontsize{16}{1}\selectfont\color{white}\textbf{$app_title_part_two$}}}
        \put(254,-620){\fontsize{11}{1}\selectfont\color{white}\textbf{Prepared for:}}
        \put(254,-640){\fontsize{11}{1}\selectfont\color{white}$organization_name$}
        \put(380,-620){\fontsize{11}{1}\selectfont\color{white}\textbf{Integrity:}}
        \put(380,-640){\parbox{50mm}{\raggedright\fontsize{8}{1}\selectfont\color{white}$integrity$}}
        \put(300,-696){\fontsize{11}{1}\selectfont\color{white}\textbf{Prepared by:}}
        \put(300,-716){\fontsize{11}{1}\selectfont\color{white}DevGuard}
        \put(38,-800){\fontsize{8}{1}\selectfont\color{white}devguard.org}
        \put(460,-800){\fontsize{8}{1}\selectfont\color{white}community@devguard.org}
    \end{picture}
\end{titlepage}
\pagecolor{white}
\clearpage
