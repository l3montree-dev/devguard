...
type statisticsService interface {
	...
	GetDependencyVulnAggregationStateAndChangeSince(assetID uuid.UUID, calculateChangeTo time.Time) (DependencyVulnAggregationStateAndChange, error)
...
func (c *httpController) GetDependencyVulnCountByScannerId(ctx core.Context) error {
	asset := core.GetAsset(ctx)
	results, err := c.statisticsService.GetDependencyVulnCountByScannerId(asset.ID)
...
func (c *httpController) GetDependencyVulnAggregationStateAndChange(ctx core.Context) error {
	...
	results, err := c.getDependencyVulnAggregationStateAndChange(compareTo, asset)
...
func (c *httpController) getDependencyVulnAggregationStateAndChange(compareTo string, asset models.Asset) (DependencyVulnAggregationStateAndChange, error) {
	// parse the date
	...
	return c.statisticsService.GetDependencyVulnAggregationStateAndChangeSince(asset.ID, calculateChangeTo)
}
