...
DevGuard includes control data derived from the "Stand der Technik Bibliothek" (Grundschutz++, ISO27001-AnnexA, ISO27001-AnnexA-to-GS++-mapping_collection, Lieferkettensicherheit-resolved_catalog), created and maintained by the Bundesamt für Sicherheit in der Informationstechnik (BSI). This content is used here to power DevGuard's compliance posture features.
