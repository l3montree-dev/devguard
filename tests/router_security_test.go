...
var routeMinLevel = map[string]shared.Role{
	...
	"GET /api/v1/organizations/:organization/logs/":                                                                                                            shared.RoleMember,
	...
	"GET /api/v1/organizations/:organization/projects/:projectSlug/logs/":                                                                                      shared.RoleMember,
	...
	"GET /api/v1/resolve/":                                                                      shared.RoleGuest,
