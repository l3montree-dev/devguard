	...
	return dtos.RiskHistoryDTO{
		History: dtos.History{
			Distribution: dtos.Distribution{
				...
				FixableLowCVSS:      history.FixableLowCVSS,
				FixableMediumCVSS:   history.FixableMediumCVSS,
				FixableHighCVSS:     history.FixableHighCVSS,
				FixableCriticalCVSS: history.FixableCriticalCVSS,
				...
				CVEPurlFixableLowCVSS:      history.CVEPurlFixableLowCVSS,
				CVEPurlFixableMediumCVSS:   history.CVEPurlFixableMediumCVSS,
				CVEPurlFixableHighCVSS:     history.CVEPurlFixableHighCVSS,
				CVEPurlFixableCriticalCVSS: history.CVEPurlFixableCriticalCVSS,
			},
			Day:                  history.Day,
